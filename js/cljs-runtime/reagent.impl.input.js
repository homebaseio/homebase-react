...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__9811){
var map__9812 = p__9811;
var map__9812__$1 = (((((!((map__9812 == null))))?(((((map__9812.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9812.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__9812):map__9812);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9812__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(jsprops.onChange = (function (p1__9818_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__9818_SHARP_);
}));
