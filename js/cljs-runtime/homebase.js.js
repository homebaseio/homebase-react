...
var vec__23891 = temp__5735__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23891,(0),null);
var verb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23891,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23891,(2),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23891,(3),null);
...
var vec__23899 = tx;
var f = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23899,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23899,(1),null);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23899,(2),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23899,(3),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function homebase$js$js__GT_schema_$_js__GT_schema_reducer(acc,p__23932){
var vec__23936 = p__23932;
var nms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23936,(0),null);
var nm = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23936,(1),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23936,(2),null);
var p = vec__23936;
...
return cljs.core.to_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function homebase$js$id__GT_entity(p__23987){
var vec__23988 = p__23987;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23988,(0),null);
...
/** @this {Function} */
(homebase.js.q_entity_array.cljs$lang$applyTo = (function (seq23965){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23966,G__23967,seq23965__$2);
}));

homebase.js.js__GT_datalog = (function homebase$js$js__GT_datalog(data){
var map__23992 = cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(data);
var map__23992__$1 = (((((!((map__23992 == null))))?(((((map__23992.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23992.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23992):map__23992);
var find = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23992__$1,"$find");
var where = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23992__$1,"$where");
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(["?",cljs.core.str.cljs$core$IFn$_invoke$arity$1(find)].join(''))], null),new cljs.core.Keyword(null,"where","where",-2044795965),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function homebase$js$js__GT_datalog_$_build_where_clause(p__23994){
var vec__23995 = p__23994;
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23995,(0),null);
var av = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23995,(1),null);
var vec__23998 = cljs.core.seq(av);
var vec__24001 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23998,(0),null);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24001,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24001,(1),null);
...
var G__24034__delegate = function (keys){
var this$ = this;
...
var G__24007 = cljs.core.first(acc);
var G__24008 = homebase.js.keywordize(key__$1);
...
var G__24009 = acc;
var G__24010 = homebase.js.keywordize(key__$1);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__24009,G__24010) : f.call(null,G__24009,G__24010));
} else {
return null;
...
while (G__24036__i < G__24036__a.length) {G__24036__a[G__24036__i] = arguments[G__24036__i + 0]; ++G__24036__i;}
  keys = new cljs.core.IndexedSeq(G__24036__a,0,null);
} 
return G__24034__delegate.call(this,keys);};
G__24034.cljs$lang$maxFixedArity = 0;
G__24034.cljs$lang$applyTo = (function (arglist__24037){
var keys = cljs.core.seq(arglist__24037);
return G__24034__delegate(keys);
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__24011){
...
var G__24015 = cljs.core.deref(conn);
var G__24016 = homebase.js.js__GT_entity_lookup(lookup);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__24015,G__24016) : datascript.core.entity.call(null,G__24015,G__24016));
});
...
/** @this {Function} */
(homebase.js.q.cljs$lang$applyTo = (function (seq24017){
var G__24018 = cljs.core.first(seq24017);
var seq24017__$1 = cljs.core.next(seq24017);
var G__24019 = cljs.core.first(seq24017__$1);
var seq24017__$2 = cljs.core.next(seq24017__$1);
var self__4723__auto__ = this;
