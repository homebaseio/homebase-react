...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function homebase$js$js__GT_schema_$_js__GT_schema_reducer(acc,p__23896){
var vec__23897 = p__23896;
var nms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23897,(0),null);
var nm = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23897,(1),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23897,(2),null);
var p = vec__23897;
...
return cljs.core.to_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function homebase$js$id__GT_entity(p__23905){
var vec__23906 = p__23905;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23906,(0),null);
...
var G__24018__delegate = function (keys){
var this$ = this;
...
var G__23922 = cljs.core.first(acc);
var G__23923 = homebase.js.keywordize(key__$1);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__23922,G__23923) : f.call(null,G__23922,G__23923));
} else {
...
while (G__24029__i < G__24029__a.length) {G__24029__a[G__24029__i] = arguments[G__24029__i + 0]; ++G__24029__i;}
  keys = new cljs.core.IndexedSeq(G__24029__a,0,null);
} 
return G__24018__delegate.call(this,keys);};
G__24018.cljs$lang$maxFixedArity = 0;
G__24018.cljs$lang$applyTo = (function (arglist__24034){
var keys = cljs.core.seq(arglist__24034);
return G__24018__delegate(keys);
});
...
var pred__23931 = cljs.core.re_find;
var expr__23932 = goog.object.get(error,"message");
if(cljs.core.truth_((function (){var G__23934 = /\[object Object\] is not ISeqable/;
...
if(cljs.core.truth_((function (){var G__23936 = /Unknown operation at \[nil nil nil nil\], expected/;
...
if(cljs.core.truth_((function (){var G__23938 = /Can't use tempid in '\[:db\.fn\/retractEntity/;
...
if(cljs.core.truth_((function (){var G__23940 = /Expected number or lookup ref for entity id, got nil/;
...
var pred__23943 = cljs.core.re_find;
var expr__23944 = goog.object.get(error,"message");
var temp__5733__auto__ = (function (){var G__23946 = /Lookup ref attribute should be marked as :db\/unique: \[:([\w-]+)\/([\w-]+) ((?!\]).+)\]/;
var G__23947 = expr__23944;
return (pred__23943.cljs$core$IFn$_invoke$arity$2 ? pred__23943.cljs$core$IFn$_invoke$arity$2(G__23946,G__23947) : pred__23943.call(null,G__23946,G__23947));
})();
if(cljs.core.truth_(temp__5733__auto__)){
...
var nmspc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23949,(1),null);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23949,(2),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23949,(3),null);
...
try{var G__23953 = cljs.core.deref(conn);
var G__23954 = homebase.js.js__GT_entity_lookup(lookup);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__23953,G__23954) : datascript.core.entity.call(null,G__23953,G__23954));
...
var pred__23957 = cljs.core.re_find;
var expr__23958 = goog.object.get(error,"message");
if(cljs.core.truth_((function (){var G__23960 = /Query should be a vector or a map/;
var G__23961 = expr__23958;
return (pred__23957.cljs$core$IFn$_invoke$arity$2 ? pred__23957.cljs$core$IFn$_invoke$arity$2(G__23960,G__23961) : pred__23957.call(null,G__23960,G__23961));
})())){
...
if(cljs.core.truth_((function (){var G__23962 = /Query for unknown vars: \[\?\]/;
var G__23963 = expr__23958;
return (pred__23957.cljs$core$IFn$_invoke$arity$2 ? pred__23957.cljs$core$IFn$_invoke$arity$2(G__23962,G__23963) : pred__23957.call(null,G__23962,G__23963));
})())){
...
var temp__5733__auto__ = (function (){var G__23964 = /Query for unknown vars: \[\?((?!\]).+)\]/;
var G__23965 = expr__23958;
return (pred__23957.cljs$core$IFn$_invoke$arity$2 ? pred__23957.cljs$core$IFn$_invoke$arity$2(G__23964,G__23965) : pred__23957.call(null,G__23964,G__23965));
})();
if(cljs.core.truth_(temp__5733__auto__)){
var p__4491__auto__ = temp__5733__auto__;
return (function (p__23966){
var vec__23968 = p__23966;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23968,(0),null);
var var$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23968,(1),null);
...
var temp__5733__auto____$1 = (function (){var G__23971 = /((?! is not ISeqable).+) is not ISeqable/;
var G__23972 = expr__23958;
return (pred__23957.cljs$core$IFn$_invoke$arity$2 ? pred__23957.cljs$core$IFn$_invoke$arity$2(G__23971,G__23972) : pred__23957.call(null,G__23971,G__23972));
})();
...
var args__4742__auto__ = [];
var len__4736__auto___24070 = arguments.length;
var i__4737__auto___24071 = (0);
while(true){
if((i__4737__auto___24071 < len__4736__auto___24070)){
args__4742__auto__.push((arguments[i__4737__auto___24071]));

var G__24072 = (i__4737__auto___24071 + (1));
i__4737__auto___24071 = G__24072;
continue;
} else {
}
break;
...
/** @this {Function} */
(homebase.js.q.cljs$lang$applyTo = (function (seq23978){
...
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23979,G__23980,seq23978__$2);
}));
