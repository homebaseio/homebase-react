...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_19046 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_19046(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_19047 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_19047(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_19048 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_19048(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_19069 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_19069(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_19073 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_19073(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_19078 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_19078(reader);
}
});
...
var G__19093 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__19094 = s.append(c);
c = G__19093;
s = G__19094;
continue;
}
