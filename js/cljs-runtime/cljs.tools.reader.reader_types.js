...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_18708 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_18708(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_18709 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_18709(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_18710 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_18710(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_18711 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_18711(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_18712 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_18712(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_18713 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_18713(reader);
}
});
...
var G__18726 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__18727 = s.append(c);
c = G__18726;
s = G__18727;
continue;
}
