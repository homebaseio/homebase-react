...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_18971 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_18971(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_18974 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_18974(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_18976 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_18976(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_18977 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_18977(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_18978 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_18978(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_18979 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_18979(reader);
}
});
...
var G__19011 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__19012 = s.append(c);
c = G__19011;
s = G__19012;
continue;
}
