...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_19039 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_19039(reader);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_19043 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_19043(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_19044 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_19044(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_19045 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_19045(reader);
}
});
...
var G__19049 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__19050 = s.append(c);
c = G__19049;
s = G__19050;
continue;
}
