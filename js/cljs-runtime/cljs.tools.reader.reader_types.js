...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_19087 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_19087(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_19088 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_19088(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_19089 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_19089(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_19090 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_19090(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_19091 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_19091(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_19092 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_19092(reader);
}
});
...
var G__19097 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__19098 = s.append(c);
c = G__19097;
s = G__19098;
continue;
}
