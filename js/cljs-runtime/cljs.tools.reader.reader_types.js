...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_19090 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_19090(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_19091 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_19091(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_19092 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_19092(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_19093 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_19093(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_19094 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_19094(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_19095 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_19095(reader);
}
});
...
var G__19100 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__19101 = s.append(c);
c = G__19100;
s = G__19101;
continue;
}
