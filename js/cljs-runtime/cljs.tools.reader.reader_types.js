...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_19042 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_19042(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_19043 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_19043(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_19044 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_19044(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_19047 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_19047(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_19048 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_19048(reader);
}
});
...
var G__19052 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__19053 = s.append(c);
c = G__19052;
s = G__19053;
continue;
}
