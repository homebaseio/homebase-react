...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_18700 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_18700(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_18701 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_18701(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_18702 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_18702(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_18703 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_18703(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_18704 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_18704(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_18705 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_18705(reader);
}
});
...
var G__18710 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__18711 = s.append(c);
c = G__18710;
s = G__18711;
continue;
}
