...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),"Current count: ",(function (){var fexpr__18631 = cljs.core.deref(example.devcards.counter1_state);
return (fexpr__18631.cljs$core$IFn$_invoke$arity$1 ? fexpr__18631.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"count","count",2139924085)) : fexpr__18631.call(null,new cljs.core.Keyword(null,"count","count",2139924085)));
...
if((typeof example !== 'undefined') && (typeof example.devcards !== 'undefined') && (typeof example.devcards.t_example$devcards18633 !== 'undefined')){
} else {
...
*/
example.devcards.t_example$devcards18633 = (function (meta18634){
this.meta18634 = meta18634;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(example.devcards.t_example$devcards18633.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_18635,meta18634__$1){
var self__ = this;
var _18635__$1 = this;
return (new example.devcards.t_example$devcards18633(meta18634__$1));
}));

(example.devcards.t_example$devcards18633.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_18635){
var self__ = this;
var _18635__$1 = this;
return self__.meta18634;
}));

(example.devcards.t_example$devcards18633.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(example.devcards.t_example$devcards18633.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__17465__auto__,devcard_opts__17466__auto__){
var self__ = this;
...
(example.devcards.t_example$devcards18633.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta18634","meta18634",372455301,null)], null);
}));

(example.devcards.t_example$devcards18633.cljs$lang$type = true);

(example.devcards.t_example$devcards18633.cljs$lang$ctorStr = "example.devcards/t_example$devcards18633");

(example.devcards.t_example$devcards18633.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"example.devcards/t_example$devcards18633");
}));

/**
 * Positional factory function for example.devcards/t_example$devcards18633.
 */
example.devcards.__GT_t_example$devcards18633 = (function example$devcards$__GT_t_example$devcards18633(meta18634){
return (new example.devcards.t_example$devcards18633(meta18634));
});

}

return (new example.devcards.t_example$devcards18633(null));
})()
