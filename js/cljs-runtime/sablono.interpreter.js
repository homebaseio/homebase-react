...
var sablono$interpreter$IInterpreter$interpret$dyn_14043 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_14043(this$);
}
});
...
var x13911_14048 = ctor.prototype;
(x13911_14048.onChange = (function (event){
var this$ = this;
...
(x13911_14048.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__13955) {
case "input":
var G__13969 = ((cljs.core.object_QMARK_(props))?props.type:false);
switch (G__13969) {
case "radio":
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq13976){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13977,G__13978,seq13976__$2);
}));
...
var vec__14004 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14004,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14004,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14004,(2),null);
