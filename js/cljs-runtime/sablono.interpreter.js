...
var sablono$interpreter$IInterpreter$interpret$dyn_13499 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_13499(this$);
}
});
...
var x13379_13539 = ctor.prototype;
(x13379_13539.onChange = (function (event){
var this$ = this;
...
(x13379_13539.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__13484) {
case "input":
var G__13485 = ((cljs.core.object_QMARK_(props))?props.type:false);
switch (G__13485) {
case "radio":
...
var len__4736__auto___13543 = arguments.length;
var i__4737__auto___13544 = (0);
while(true){
if((i__4737__auto___13544 < len__4736__auto___13543)){
args__4742__auto__.push((arguments[i__4737__auto___13544]));

var G__13545 = (i__4737__auto___13544 + (1));
i__4737__auto___13544 = G__13545;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq13486){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13487,G__13488,seq13486__$2);
}));
...
var vec__13490 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13490,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13490,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13490,(2),null);
