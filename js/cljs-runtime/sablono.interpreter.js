...
var sablono$interpreter$IInterpreter$interpret$dyn_13475 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_13475(this$);
}
});
...
var x13367_13476 = ctor.prototype;
(x13367_13476.onChange = (function (event){
var this$ = this;
...
(x13367_13476.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__13380) {
case "input":
var G__13381 = ((cljs.core.object_QMARK_(props))?props.type:false);
switch (G__13381) {
case "radio":
...
var G__13502 = (i__4737__auto___13500 + (1));
i__4737__auto___13500 = G__13502;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq13382){
var G__13383 = cljs.core.first(seq13382);
var seq13382__$1 = cljs.core.next(seq13382);
var G__13384 = cljs.core.first(seq13382__$1);
var seq13382__$2 = cljs.core.next(seq13382__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13383,G__13384,seq13382__$2);
}));
...
var vec__13452 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13452,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13452,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13452,(2),null);
