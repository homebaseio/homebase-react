...
var sablono$interpreter$IInterpreter$interpret$dyn_13824 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_13824(this$);
}
});
...
var x13766_13838 = ctor.prototype;
(x13766_13838.onChange = (function (event){
var this$ = this;
...
(x13766_13838.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__13796) {
case "input":
var G__13797 = ((cljs.core.object_QMARK_(props))?props.type:false);
switch (G__13797) {
case "radio":
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq13798){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13799,G__13800,seq13798__$2);
}));
...
var vec__13806 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13806,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13806,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13806,(2),null);
