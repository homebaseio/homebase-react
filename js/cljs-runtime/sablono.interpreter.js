...
var sablono$interpreter$IInterpreter$interpret$dyn_13278 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_13278(this$);
}
});
...
var x13215_13281 = ctor.prototype;
(x13215_13281.onChange = (function (event){
var this$ = this;
...
(x13215_13281.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__13258) {
case "input":
var G__13259 = ((cljs.core.object_QMARK_(props))?props.type:false);
switch (G__13259) {
case "radio":
...
var len__4736__auto___13292 = arguments.length;
var i__4737__auto___13293 = (0);
while(true){
if((i__4737__auto___13293 < len__4736__auto___13292)){
args__4742__auto__.push((arguments[i__4737__auto___13293]));

var G__13294 = (i__4737__auto___13293 + (1));
i__4737__auto___13293 = G__13294;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq13260){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13261,G__13262,seq13260__$2);
}));
...
var vec__13270 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13270,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13270,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13270,(2),null);
