...
var sablono$interpreter$IInterpreter$interpret$dyn_13607 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_13607(this$);
}
});
...
var x13510_13613 = ctor.prototype;
(x13510_13613.onChange = (function (event){
var this$ = this;
...
(x13510_13613.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__13532) {
case "input":
var G__13533 = ((cljs.core.object_QMARK_(props))?props.type:false);
switch (G__13533) {
case "radio":
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq13584){
...
var vec__13588 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13588,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13588,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13588,(2),null);
