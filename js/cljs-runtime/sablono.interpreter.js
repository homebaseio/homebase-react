...
var sablono$interpreter$IInterpreter$interpret$dyn_13718 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_13718(this$);
}
});
...
var x13657_13719 = ctor.prototype;
(x13657_13719.onChange = (function (event){
var this$ = this;
...
(x13657_13719.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__13678) {
case "input":
var G__13679 = ((cljs.core.object_QMARK_(props))?props.type:false);
switch (G__13679) {
case "radio":
...
args__4742__auto__.push((arguments[i__4737__auto___13742]));
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq13685){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13686,G__13687,seq13685__$2);
}));
...
var vec__13689 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13689,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13689,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13689,(2),null);
