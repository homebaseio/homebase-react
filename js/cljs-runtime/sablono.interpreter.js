...
var sablono$interpreter$IInterpreter$interpret$dyn_13531 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_13531(this$);
}
});
...
var x13445_13532 = ctor.prototype;
(x13445_13532.onChange = (function (event){
var this$ = this;
...
(x13445_13532.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__13476) {
case "input":
var G__13477 = ((cljs.core.object_QMARK_(props))?props.type:false);
switch (G__13477) {
case "radio":
...
var len__4736__auto___13550 = arguments.length;
var i__4737__auto___13551 = (0);
while(true){
if((i__4737__auto___13551 < len__4736__auto___13550)){
args__4742__auto__.push((arguments[i__4737__auto___13551]));

var G__13552 = (i__4737__auto___13551 + (1));
i__4737__auto___13551 = G__13552;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq13478){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13479,G__13480,seq13478__$2);
}));
...
var vec__13491 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13491,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13491,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13491,(2),null);
