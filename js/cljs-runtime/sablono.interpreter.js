...
var sablono$interpreter$IInterpreter$interpret$dyn_14114 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_14114(this$);
}
});
...
var x14038_14121 = ctor.prototype;
(x14038_14121.onChange = (function (event){
var this$ = this;
...
(x14038_14121.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__14051) {
case "input":
var G__14052 = ((cljs.core.object_QMARK_(props))?props.type:false);
switch (G__14052) {
case "radio":
...
var len__4736__auto___14130 = arguments.length;
var i__4737__auto___14131 = (0);
while(true){
if((i__4737__auto___14131 < len__4736__auto___14130)){
args__4742__auto__.push((arguments[i__4737__auto___14131]));

var G__14132 = (i__4737__auto___14131 + (1));
i__4737__auto___14131 = G__14132;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq14055){
...
var vec__14066 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14066,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14066,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14066,(2),null);
