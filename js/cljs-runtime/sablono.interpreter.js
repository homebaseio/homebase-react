...
var sablono$interpreter$IInterpreter$interpret$dyn_13016 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_13016(this$);
}
});
...
var x12850_13021 = ctor.prototype;
(x12850_13021.onChange = (function (event){
var this$ = this;
...
(x12850_13021.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__12926) {
case "input":
var G__12929 = ((cljs.core.object_QMARK_(props))?props.type:false);
switch (G__12929) {
case "radio":
...
var len__4736__auto___13029 = arguments.length;
var i__4737__auto___13030 = (0);
while(true){
if((i__4737__auto___13030 < len__4736__auto___13029)){
args__4742__auto__.push((arguments[i__4737__auto___13030]));

var G__13031 = (i__4737__auto___13030 + (1));
i__4737__auto___13030 = G__13031;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq12944){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12945,G__12946,seq12944__$2);
}));
...
var vec__12964 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12964,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12964,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12964,(2),null);
