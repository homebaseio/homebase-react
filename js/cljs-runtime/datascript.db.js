...
var datascript$db$IDB$_attrs_by$dyn_20433 = (function (db,property){
var x__4428__auto__ = (((db == null))?null:db);
...
return datascript$db$IDB$_attrs_by$dyn_20433(db,property);
}
});
...
var ex_data_20485__$1 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ex_data_20465,new cljs.core.Keyword(null,"value","value",305978217),attr_20484);
...
var ex_data_20509__$1 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ex_data_20499,new cljs.core.Keyword(null,"value","value",305978217),attr_20508);
...
var temp__5739__auto___20534 = cljs.core.first(cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2(datascript.db.datom_QMARK_,datoms));
if((temp__5739__auto___20534 == null)){
} else {
var not_datom_20535 = temp__5739__auto___20534;
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["init-db expects list of Datoms, got ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.type(not_datom_20535)], 0))].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),new cljs.core.Keyword(null,"init-db","init-db",1595181278)], null));
}
...
var G__20536 = cljs.core.next(xs);
var G__20537 = cljs.core.next(ys);
xs = G__20536;
ys = G__20537;
continue;
} else {
...
var G__20612 = cljs.core.rest(s__20344__$1);
s__20344__$1 = G__20612;
continue;
}
} else {
var G__20613 = cljs.core.rest(s__20344__$1);
s__20344__$1 = G__20613;
continue;
}
} else {
return null;
...
var G__20630 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(report,new cljs.core.Keyword("datascript.db","queued-tuples","datascript.db/queued-tuples",-762852029));
var G__20631 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.flush_tuples(report),entities);
report = G__20630;
es = G__20631;
continue;
} else {
...
var G__20637 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,old_eid,id);
var G__20638 = cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(entity,new cljs.core.Keyword("db","id","db/id",-1388397098),id),entities);
report = G__20637;
es = G__20638;
continue;
} else {
...
var G__20639 = report;
var G__20640 = cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(entity,new cljs.core.Keyword("db","id","db/id",-1388397098),id),entities);
report = G__20639;
es = G__20640;
continue;
} else {
...
var G__20641 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,old_eid,upserted_eid);
var G__20642 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.explode(db,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(entity_SINGLEQUOTE_,new cljs.core.Keyword("db","id","db/id",-1388397098),upserted_eid)),entities);
report = G__20641;
es = G__20642;
continue;
}
...
var G__20654 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,old_eid,new_eid);
var G__20655 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.explode(db,new_entity),entities);
report = G__20654;
es = G__20655;
continue;
} else {
...
var G__20656 = report;
var G__20657 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,db,args),entities);
report = G__20656;
es = G__20657;
continue;
} else {
...
var G__20658 = report;
var G__20659 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(fun,db,args),entities);
report = G__20658;
es = G__20659;
continue;
} else {
...
,datoms))){
var G__20663 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e__$2,a__$1,nv__$1], null));
...
var G__20665 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e__$2,a__$1,nv__$1], null));
...
var G__20667 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,e,datascript.db.current_tx(report));
var G__20668 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,datascript.db.current_tx(report),a,v], null),entities);
report = G__20667;
es = G__20668;
continue;
} else {
if(((datascript.db.ref_QMARK_(db,a)) && (datascript.db.tx_id_QMARK_(v)))){
var G__20669 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,v,datascript.db.current_tx(report));
var G__20670 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,e,a,datascript.db.current_tx(report)], null),entities);
report = G__20669;
es = G__20670;
continue;
} else {
...
var G__20671 = report_SINGLEQUOTE_;
var G__20672 = es;
report = G__20671;
es = G__20672;
continue;
...
var G__20673 = report_SINGLEQUOTE_;
var G__20674 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,e,a,resolved], null),entities);
report = G__20673;
es = G__20674;
continue;
}
...
var G__20684 = datascript.db.transact_retract_datom(report,old_datom);
...
var G__20688 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(datascript.db.transact_retract_datom,report,datoms);
var G__20689 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.retract_components(db,datoms),entities);
report = G__20688;
es = G__20689;
continue;
}
...
var G__20692 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(datascript.db.transact_retract_datom,report,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(e_datoms,v_datoms));
var G__20693 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.retract_components(db,e_datoms),entities);
report = G__20692;
es = G__20693;
continue;
}
...
var G__20694 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e,a,v,tx], null));
...
var G__20696 = report;
var G__20697 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","retract","db/retract",-1549825231),e,a,v], null),entities);
report = G__20696;
es = G__20697;
continue;
}
