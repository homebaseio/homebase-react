...
var datascript$db$IDB$_attrs_by$dyn_20441 = (function (db,property){
var x__4428__auto__ = (((db == null))?null:db);
...
return datascript$db$IDB$_attrs_by$dyn_20441(db,property);
}
});
...
var temp__5739__auto___20538 = cljs.core.first(cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2(datascript.db.datom_QMARK_,datoms));
if((temp__5739__auto___20538 == null)){
} else {
var not_datom_20539 = temp__5739__auto___20538;
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["init-db expects list of Datoms, got ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.type(not_datom_20539)], 0))].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),new cljs.core.Keyword(null,"init-db","init-db",1595181278)], null));
}
...
var G__20555 = db;
var G__20556 = cljs.core.array_seq.cljs$core$IFn$_invoke$arity$1(eid);
db = G__20555;
eid = G__20556;
continue;
} else {
...
var G__20573 = cljs.core.rest(s__20344__$1);
s__20344__$1 = G__20573;
continue;
}
} else {
...
var G__20583 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(report,new cljs.core.Keyword("datascript.db","queued-tuples","datascript.db/queued-tuples",-762852029));
var G__20584 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.flush_tuples(report),entities);
report = G__20583;
es = G__20584;
continue;
} else {
var G__20585 = report;
var G__20586 = entities;
report = G__20585;
es = G__20586;
continue;
}
...
var G__20587 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,old_eid,id);
var G__20588 = cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(entity,new cljs.core.Keyword("db","id","db/id",-1388397098),id),entities);
report = G__20587;
es = G__20588;
continue;
} else {
...
var G__20589 = report;
var G__20590 = cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(entity,new cljs.core.Keyword("db","id","db/id",-1388397098),id),entities);
report = G__20589;
es = G__20590;
continue;
} else {
...
var G__20591 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,old_eid,upserted_eid);
var G__20592 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.explode(db,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(entity_SINGLEQUOTE_,new cljs.core.Keyword("db","id","db/id",-1388397098),upserted_eid)),entities);
report = G__20591;
es = G__20592;
continue;
}
...
var G__20593 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,old_eid,new_eid);
var G__20594 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.explode(db,new_entity),entities);
report = G__20593;
es = G__20594;
continue;
} else {
...
var G__20595 = report;
var G__20596 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,db,args),entities);
report = G__20595;
es = G__20596;
continue;
} else {
...
var G__20598 = report;
var G__20599 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(fun,db,args),entities);
report = G__20598;
es = G__20599;
continue;
} else {
...
,datoms))){
var G__20604 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e__$2,a__$1,nv__$1], null));
...
var G__20606 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e__$2,a__$1,nv__$1], null));
var G__20607 = entities;
report = G__20606;
es = G__20607;
continue;
} else {
...
var G__20608 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,e,datascript.db.current_tx(report));
var G__20609 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,datascript.db.current_tx(report),a,v], null),entities);
report = G__20608;
es = G__20609;
continue;
} else {
if(((datascript.db.ref_QMARK_(db,a)) && (datascript.db.tx_id_QMARK_(v)))){
var G__20610 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,v,datascript.db.current_tx(report));
var G__20611 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,e,a,datascript.db.current_tx(report)], null),entities);
report = G__20610;
es = G__20611;
continue;
} else {
...
var G__20612 = report_SINGLEQUOTE_;
var G__20613 = es;
report = G__20612;
es = G__20613;
continue;
...
var G__20614 = report_SINGLEQUOTE_;
var G__20615 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,e,a,resolved], null),entities);
report = G__20614;
es = G__20615;
continue;
}
...
var G__20616 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,e,eid);
var G__20617 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,eid,a,v], null),entities);
report = G__20616;
es = G__20617;
continue;
}
...
var G__20618 = datascript.db.transact_add(report,entity);
...
var G__20624 = datascript.db.transact_retract_datom(report,old_datom);
...
var G__20628 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(datascript.db.transact_retract_datom,report,datoms);
var G__20629 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.retract_components(db,datoms),entities);
report = G__20628;
es = G__20629;
continue;
}
