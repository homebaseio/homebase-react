...
var G__20493 = seq__20231;
var G__20494 = chunk__20232;
var G__20495 = count__20233;
var G__20496 = (i__20234 + (1));
seq__20231 = G__20493;
chunk__20232 = G__20494;
count__20233 = G__20495;
i__20234 = G__20496;
continue;
} else {
...
var G__20497 = cljs.core.chunk_rest(seq__20231__$1);
var G__20498 = c__4556__auto__;
var G__20499 = cljs.core.count(c__4556__auto__);
var G__20500 = (0);
seq__20231 = G__20497;
chunk__20232 = G__20498;
count__20233 = G__20499;
i__20234 = G__20500;
continue;
} else {
...
var temp__5739__auto___20539 = cljs.core.first(cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2(datascript.db.datom_QMARK_,datoms));
if((temp__5739__auto___20539 == null)){
} else {
var not_datom_20540 = temp__5739__auto___20539;
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["init-db expects list of Datoms, got ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.type(not_datom_20540)], 0))].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),new cljs.core.Keyword(null,"init-db","init-db",1595181278)], null));
}
...
var G__20607 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,old_eid,new_eid);
var G__20608 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.explode(db,new_entity),entities);
report = G__20607;
es = G__20608;
continue;
} else {
...
var G__20609 = report;
var G__20610 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,db,args),entities);
report = G__20609;
es = G__20610;
continue;
} else {
...
var G__20611 = report;
var G__20612 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(fun,db,args),entities);
report = G__20611;
es = G__20612;
continue;
} else {
...
,datoms))){
var G__20613 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e__$2,a__$1,nv__$1], null));
var G__20614 = entities;
report = G__20613;
es = G__20614;
continue;
} else {
...
var G__20616 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e__$2,a__$1,nv__$1], null));
var G__20617 = entities;
report = G__20616;
es = G__20617;
continue;
} else {
...
var G__20618 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,e,datascript.db.current_tx(report));
var G__20619 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,datascript.db.current_tx(report),a,v], null),entities);
report = G__20618;
es = G__20619;
continue;
} else {
if(((datascript.db.ref_QMARK_(db,a)) && (datascript.db.tx_id_QMARK_(v)))){
var G__20621 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,v,datascript.db.current_tx(report));
var G__20622 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,e,a,datascript.db.current_tx(report)], null),entities);
report = G__20621;
es = G__20622;
continue;
} else {
...
var G__20648 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e,a,v,tx], null));
...
var G__20650 = report;
var G__20651 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","retract","db/retract",-1549825231),e,a,v], null),entities);
report = G__20650;
es = G__20651;
continue;
}
