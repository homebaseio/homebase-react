...
var G__20824 = only_a;
var G__20825 = only_b;
var G__20826 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(both,first_a);
...
if((diff < (0))){
var G__20829 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(only_a,first_a);
var G__20830 = only_b;
var G__20831 = both;
var G__20832 = cljs.core.next(a__$1);
var G__20833 = b__$1;
only_a = G__20829;
only_b = G__20830;
both = G__20831;
...
if((diff > (0))){
var G__20834 = only_a;
var G__20835 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(only_b,first_b);
var G__20836 = both;
var G__20837 = a__$1;
var G__20838 = cljs.core.next(b__$1);
only_a = G__20834;
only_b = G__20835;
both = G__20836;
a__$1 = G__20837;
...
var datascript$db$ISearch$_search$dyn_20839 = (function (data,pattern){
...
return datascript$db$ISearch$_search$dyn_20839(data,pattern);
}
});
...
var datascript$db$IIndexAccess$_datoms$dyn_20849 = (function (db,index,components){
...
return datascript$db$IIndexAccess$_datoms$dyn_20849(db,index,components);
}
});

var datascript$db$IIndexAccess$_seek_datoms$dyn_20850 = (function (db,index,components){
var x__4428__auto__ = (((db == null))?null:db);
...
return datascript$db$IIndexAccess$_seek_datoms$dyn_20850(db,index,components);
}
});
...
var datascript$db$IDB$_attrs_by$dyn_20859 = (function (db,property){
var x__4428__auto__ = (((db == null))?null:db);
...
return datascript$db$IDB$_attrs_by$dyn_20859(db,property);
}
});
...
var G__20587_20866 = attr;
var G__20588_20867 = (new cljs.core.List(null,new cljs.core.Symbol(null,"-index-range","-index-range",898114142,null),(new cljs.core.List(null,new cljs.core.Symbol(null,"db","db",-1661185010,null),(new cljs.core.List(null,attr,(new cljs.core.List(null,start,(new cljs.core.List(null,end,null,(1),null)),(2),null)),(3),null)),(4),null)),(5),null));
(datascript.db.validate_attr.cljs$core$IFn$_invoke$arity$2 ? datascript.db.validate_attr.cljs$core$IFn$_invoke$arity$2(G__20587_20866,G__20588_20867) : datascript.db.validate_attr.call(null,G__20587_20866,G__20588_20867));
...
var G__20908 = seq__20618;
var G__20909 = chunk__20619;
var G__20910 = count__20620;
var G__20911 = (i__20621 + (1));
seq__20618 = G__20908;
chunk__20619 = G__20909;
count__20620 = G__20910;
i__20621 = G__20911;
continue;
} else {
...
var G__20912 = cljs.core.chunk_rest(seq__20618__$1);
var G__20913 = c__4556__auto__;
var G__20914 = cljs.core.count(c__4556__auto__);
var G__20915 = (0);
seq__20618 = G__20912;
chunk__20619 = G__20913;
count__20620 = G__20914;
i__20621 = G__20915;
continue;
} else {
...
var comp_QMARK__20916 = new cljs.core.Keyword("db","isComponent","db/isComponent",423352398).cljs$core$IFn$_invoke$arity$2(kv,false);
datascript.db.validate_schema_key(a,new cljs.core.Keyword("db","isComponent","db/isComponent",423352398),new cljs.core.Keyword("db","isComponent","db/isComponent",423352398).cljs$core$IFn$_invoke$arity$1(kv),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [true,null,false,null], null), null));

if(cljs.core.truth_((function (){var and__4115__auto__ = comp_QMARK__20916;
if(cljs.core.truth_(and__4115__auto__)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","valueType","db/valueType",1827971944).cljs$core$IFn$_invoke$arity$1(kv),new cljs.core.Keyword("db.type","ref","db.type/ref",-1728373079));
} else {
return and__4115__auto__;
...
if(cljs.core.contains_QMARK_(kv,new cljs.core.Keyword("db","tupleAttrs","db/tupleAttrs",250080092))){
var ex_data_20917 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"error","error",-978969032),new cljs.core.Keyword("schema","validation","schema/validation",1178447161),new cljs.core.Keyword(null,"attribute","attribute",-2074029119),a,new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword("db","tupleAttrs","db/tupleAttrs",250080092)], null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db.cardinality","many","db.cardinality/many",772806234),new cljs.core.Keyword("db","cardinality","db/cardinality",-104975659).cljs$core$IFn$_invoke$arity$1(kv))){
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([a], 0))," has :db/tupleAttrs, must be :db.cardinality/one"].join(''),ex_data_20917);
} else {
}

var attrs_20918 = new cljs.core.Keyword("db","tupleAttrs","db/tupleAttrs",250080092).cljs$core$IFn$_invoke$arity$1(kv);
if(cljs.core.sequential_QMARK_(attrs_20918)){
} else {
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([a], 0))," :db/tupleAttrs must be a sequential collection, got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([attrs_20918], 0))].join(''),ex_data_20917);
}

if(cljs.core.empty_QMARK_(attrs_20918)){
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([a], 0))," :db/tupleAttrs can\u2019t be empty"].join(''),ex_data_20917);
} else {
}

var seq__20652_20920 = cljs.core.seq(attrs_20918);
var chunk__20654_20921 = null;
var count__20655_20922 = (0);
var i__20656_20923 = (0);
while(true){
if((i__20656_20923 < count__20655_20922)){
var attr_20924 = chunk__20654_20921.cljs$core$IIndexed$_nth$arity$2(null,i__20656_20923);
var ex_data_20925__$1 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ex_data_20917,new cljs.core.Keyword(null,"value","value",305978217),attr_20924);
if(cljs.core.contains_QMARK_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(schema,attr_20924),new cljs.core.Keyword("db","tupleAttrs","db/tupleAttrs",250080092))){
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([a], 0))," :db/tupleAttrs can\u2019t depend on another tuple attribute: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([attr_20924], 0))].join(''),ex_data_20925__$1);
} else {
}

if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db.cardinality","many","db.cardinality/many",772806234),new cljs.core.Keyword("db","cardinality","db/cardinality",-104975659).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(schema,attr_20924)))){
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([a], 0))," :db/tupleAttrs can\u2019t depend on :db.cardinality/many attribute: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([attr_20924], 0))].join(''),ex_data_20925__$1);
} else {
}


var G__20931 = seq__20652_20920;
var G__20932 = chunk__20654_20921;
var G__20933 = count__20655_20922;
var G__20934 = (i__20656_20923 + (1));
seq__20652_20920 = G__20931;
chunk__20654_20921 = G__20932;
count__20655_20922 = G__20933;
i__20656_20923 = G__20934;
continue;
} else {
var temp__5735__auto___20935__$1 = cljs.core.seq(seq__20652_20920);
if(temp__5735__auto___20935__$1){
var seq__20652_20936__$1 = temp__5735__auto___20935__$1;
if(cljs.core.chunked_seq_QMARK_(seq__20652_20936__$1)){
var c__4556__auto___20937 = cljs.core.chunk_first(seq__20652_20936__$1);
var G__20938 = cljs.core.chunk_rest(seq__20652_20936__$1);
var G__20939 = c__4556__auto___20937;
var G__20940 = cljs.core.count(c__4556__auto___20937);
var G__20941 = (0);
seq__20652_20920 = G__20938;
chunk__20654_20921 = G__20939;
count__20655_20922 = G__20940;
i__20656_20923 = G__20941;
continue;
} else {
var attr_20942 = cljs.core.first(seq__20652_20936__$1);
var ex_data_20943__$1 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ex_data_20917,new cljs.core.Keyword(null,"value","value",305978217),attr_20942);
if(cljs.core.contains_QMARK_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(schema,attr_20942),new cljs.core.Keyword("db","tupleAttrs","db/tupleAttrs",250080092))){
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([a], 0))," :db/tupleAttrs can\u2019t depend on another tuple attribute: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([attr_20942], 0))].join(''),ex_data_20943__$1);
} else {
}

if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db.cardinality","many","db.cardinality/many",772806234),new cljs.core.Keyword("db","cardinality","db/cardinality",-104975659).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(schema,attr_20942)))){
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([a], 0))," :db/tupleAttrs can\u2019t depend on :db.cardinality/many attribute: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([attr_20942], 0))].join(''),ex_data_20943__$1);
} else {
}


var G__20945 = cljs.core.next(seq__20652_20936__$1);
var G__20946 = null;
var G__20947 = (0);
var G__20948 = (0);
seq__20652_20920 = G__20945;
chunk__20654_20921 = G__20946;
count__20655_20922 = G__20947;
i__20656_20923 = G__20948;
continue;
}
} else {
}
...
var G__20949 = cljs.core.next(seq__20618__$1);
var G__20950 = null;
var G__20951 = (0);
var G__20952 = (0);
seq__20618 = G__20949;
chunk__20619 = G__20950;
count__20620 = G__20951;
i__20621 = G__20952;
continue;
}
} else {
...
var temp__5739__auto___20959 = cljs.core.first(cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2(datascript.db.datom_QMARK_,datoms));
if((temp__5739__auto___20959 == null)){
} else {
var not_datom_20960 = temp__5739__auto___20959;
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["init-db expects list of Datoms, got ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.type(not_datom_20960)], 0))].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),new cljs.core.Keyword(null,"init-db","init-db",1595181278)], null));
}
...
var G__20961 = cljs.core.next(xs);
var G__20962 = cljs.core.next(ys);
xs = G__20961;
ys = G__20962;
continue;
} else {
...
if(cljs.core.truth_(a)){
var G__20670_20963 = a;
var G__20671_20964 = (new cljs.core.List(null,new cljs.core.Symbol(null,"resolve-datom","resolve-datom",-294110827,null),(new cljs.core.List(null,new cljs.core.Symbol(null,"db","db",-1661185010,null),(new cljs.core.List(null,e,(new cljs.core.List(null,a,(new cljs.core.List(null,v,(new cljs.core.List(null,t,null,(1),null)),(2),null)),(3),null)),(4),null)),(5),null)),(6),null));
(datascript.db.validate_attr.cljs$core$IFn$_invoke$arity$2 ? datascript.db.validate_attr.cljs$core$IFn$_invoke$arity$2(G__20670_20963,G__20671_20964) : datascript.db.validate_attr.call(null,G__20670_20963,G__20671_20964));
} else {
}
...
var G__20975 = db;
var G__20976 = cljs.core.array_seq.cljs$core$IFn$_invoke$arity$1(eid);
db = G__20975;
eid = G__20976;
continue;
} else {
...
var G__20999 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(report,new cljs.core.Keyword("datascript.db","queued-tuples","datascript.db/queued-tuples",-762852029));
var G__21000 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.flush_tuples(report),entities);
report = G__20999;
es = G__21000;
continue;
} else {
...
var G__21007 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,old_eid,upserted_eid);
var G__21008 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.explode(db,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(entity_SINGLEQUOTE_,new cljs.core.Keyword("db","id","db/id",-1388397098),upserted_eid)),entities);
report = G__21007;
es = G__21008;
continue;
}
...
var G__21009 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,old_eid,new_eid);
var G__21010 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.explode(db,new_entity),entities);
report = G__21009;
es = G__21010;
continue;
} else {
...
var G__21011 = report;
var G__21012 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,db,args),entities);
report = G__21011;
es = G__21012;
continue;
} else {
...
var G__21013 = report;
var G__21014 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(fun,db,args),entities);
report = G__21013;
es = G__21014;
continue;
} else {
...
,datoms))){
var G__21016 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e__$2,a__$1,nv__$1], null));
var G__21017 = entities;
report = G__21016;
es = G__21017;
continue;
} else {
