...
while (G__9872__i < G__9872__a.length) {G__9872__a[G__9872__i] = arguments[G__9872__i + 0]; ++G__9872__i;}
  args = new cljs.core.IndexedSeq(G__9872__a,0,null);
} 
...
var or__4126__auto__ = (function (){var G__9792 = c;
var G__9792__$1 = (((G__9792 == null))?null:G__9792.constructor);
if((G__9792__$1 == null)){
return null;
} else {
return G__9792__$1.displayName;
}
})();
...
var G__9795 = c;
var G__9795__$1 = (((G__9795 == null))?null:G__9795.constructor);
if((G__9795__$1 == null)){
return null;
} else {
return G__9795__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__9806 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__9807 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__9807);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__9806);
}});
...
var c = this;
var G__9816_9877 = goog.object.get(c,"cljsRatom");
if((G__9816_9877 == null)){
} else {
reagent.ratom.dispose_BANG_(G__9816_9877);
}
...
var renders_9878 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_9879 = cljs.core.first(cljs.core.vals(renders_9878));
...
if((cljs.core.count(renders_9878) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_9878))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_9879)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_9879], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__9837 = o;
goog.object.set(G__9837,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__9855 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__9856 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__9856);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__9855);
}});
...
var vec__9859 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9859,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9859,(1),null);
...
var G__9865 = goog.object.get(reagent_state,"cljsRatom");
if((G__9865 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__9865);
}
});
}),[]);
