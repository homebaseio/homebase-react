...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__9860 = c;
var G__9860__$1 = (((G__9860 == null))?null:G__9860.prototype);
if((G__9860__$1 == null)){
return null;
} else {
return G__9860__$1.reagentRender;
}
})() == null)))));
});
...
var or__4126__auto__ = (function (){var G__9869 = c;
var G__9869__$1 = (((G__9869 == null))?null:G__9869.constructor);
if((G__9869__$1 == null)){
return null;
} else {
return G__9869__$1.displayName;
}
})();
...
var G__9870 = c;
var G__9870__$1 = (((G__9870 == null))?null:G__9870.constructor);
if((G__9870__$1 == null)){
return null;
} else {
return G__9870__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__9873 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__9874 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__9874);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__9873);
}});
...
var c = this;
var G__9889_9958 = goog.object.get(c,"cljsRatom");
if((G__9889_9958 == null)){
} else {
reagent.ratom.dispose_BANG_(G__9889_9958);
}
...
var renders_9966 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_9967 = cljs.core.first(cljs.core.vals(renders_9966));
...
if((cljs.core.count(renders_9966) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_9966))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_9967)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_9967], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__9900 = o;
goog.object.set(G__9900,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__9908 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__9909 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__9909);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__9908);
}});
...
var vec__9910 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9910,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9910,(1),null);
...
var G__9913 = goog.object.get(reagent_state,"cljsRatom");
if((G__9913 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__9913);
}
});
}),[]);
