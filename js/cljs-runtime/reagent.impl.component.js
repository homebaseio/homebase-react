...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__9997 = c;
var G__9997__$1 = (((G__9997 == null))?null:G__9997.prototype);
if((G__9997__$1 == null)){
return null;
} else {
return G__9997__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__9999 = c;
var G__9999__$1 = (((G__9999 == null))?null:G__9999.prototype);
if((G__9999__$1 == null)){
return null;
} else {
return G__9999__$1.render;
}
})() == null)))));
});
...
var G__10007 = c;
var G__10007__$1 = (((G__10007 == null))?null:G__10007.constructor);
if((G__10007__$1 == null)){
return null;
} else {
return G__10007__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__10011 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__10012 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__10012);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__10011);
}});
reagent.impl.component.rat_opts = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"no-cache","no-cache",1588056370),true], null);
reagent.impl.component.custom_wrapper = (function reagent$impl$component$custom_wrapper(key,f){
var G__10013 = key;
var G__10013__$1 = (((G__10013 instanceof cljs.core.Keyword))?G__10013.fqn:null);
switch (G__10013__$1) {
...
var c = this;
var G__10016_10052 = goog.object.get(c,"cljsRatom");
if((G__10016_10052 == null)){
} else {
reagent.ratom.dispose_BANG_(G__10016_10052);
}
...
var renders_10064 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_10065 = cljs.core.first(cljs.core.vals(renders_10064));
...
if((cljs.core.count(renders_10064) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_10064))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_10065)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_10065], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__10017 = o;
goog.object.set(G__10017,cljs.core.name(k),v);
...
while (G__10099__i < G__10099__a.length) {G__10099__a[G__10099__i] = arguments[G__10099__i + 0]; ++G__10099__i;}
  args = new cljs.core.IndexedSeq(G__10099__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__10022 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__10023 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__10023);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__10022);
}});
...
var vec__10024 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10024,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10024,(1),null);
...
var G__10027 = goog.object.get(reagent_state,"cljsRatom");
if((G__10027 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__10027);
}
});
}),[]);
