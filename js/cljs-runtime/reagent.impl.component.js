...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__9837 = c;
var G__9837__$1 = (((G__9837 == null))?null:G__9837.prototype);
if((G__9837__$1 == null)){
return null;
} else {
return G__9837__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__9839 = c;
var G__9839__$1 = (((G__9839 == null))?null:G__9839.prototype);
if((G__9839__$1 == null)){
return null;
} else {
return G__9839__$1.render;
}
})() == null)))));
});
...
var or__4126__auto__ = (function (){var G__9846 = c;
var G__9846__$1 = (((G__9846 == null))?null:G__9846.constructor);
if((G__9846__$1 == null)){
return null;
} else {
return G__9846__$1.displayName;
}
})();
...
var G__9847 = c;
var G__9847__$1 = (((G__9847 == null))?null:G__9847.constructor);
if((G__9847__$1 == null)){
return null;
} else {
return G__9847__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__9848 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__9849 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__9849);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__9848);
}});
...
var c = this;
var G__9856_9906 = goog.object.get(c,"cljsRatom");
if((G__9856_9906 == null)){
} else {
reagent.ratom.dispose_BANG_(G__9856_9906);
}
...
var renders_9907 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_9908 = cljs.core.first(cljs.core.vals(renders_9907));
...
if((cljs.core.count(renders_9907) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_9907))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_9908)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_9908], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__9862 = o;
goog.object.set(G__9862,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__9877 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__9878 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__9878);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__9877);
}});
...
var vec__9880 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9880,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9880,(1),null);
...
var G__9883 = goog.object.get(reagent_state,"cljsRatom");
if((G__9883 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__9883);
}
});
}),[]);
