...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__18408 = c;
var G__18408__$1 = (((G__18408 == null))?null:G__18408.prototype);
if((G__18408__$1 == null)){
return null;
} else {
return G__18408__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__18410 = c;
var G__18410__$1 = (((G__18410 == null))?null:G__18410.prototype);
if((G__18410__$1 == null)){
return null;
} else {
return G__18410__$1.render;
}
})() == null)))));
});
...
var or__4126__auto__ = (function (){var G__18419 = c;
var G__18419__$1 = (((G__18419 == null))?null:G__18419.constructor);
if((G__18419__$1 == null)){
return null;
} else {
return G__18419__$1.displayName;
}
})();
...
var G__18420 = c;
var G__18420__$1 = (((G__18420 == null))?null:G__18420.constructor);
if((G__18420__$1 == null)){
return null;
} else {
return G__18420__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__18421 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__18422 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__18422);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__18421);
}});
...
var renders_18513 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_18514 = cljs.core.first(cljs.core.vals(renders_18513));
...
if((cljs.core.count(renders_18513) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_18513))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_18514)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_18514], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__18433 = o;
goog.object.set(G__18433,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__18442 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__18443 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__18443);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__18442);
}});
