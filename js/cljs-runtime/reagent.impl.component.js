...
while (G__9602__i < G__9602__a.length) {G__9602__a[G__9602__i] = arguments[G__9602__i + 0]; ++G__9602__i;}
  args = new cljs.core.IndexedSeq(G__9602__a,0,null);
} 
...
var or__4126__auto__ = (function (){var G__9557 = c;
var G__9557__$1 = (((G__9557 == null))?null:G__9557.constructor);
if((G__9557__$1 == null)){
return null;
} else {
return G__9557__$1.displayName;
}
})();
...
var G__9558 = c;
var G__9558__$1 = (((G__9558 == null))?null:G__9558.constructor);
if((G__9558__$1 == null)){
return null;
} else {
return G__9558__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__9559 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__9560 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__9560);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__9559);
}});
...
var c = this;
var G__9568_9650 = goog.object.get(c,"cljsRatom");
if((G__9568_9650 == null)){
} else {
reagent.ratom.dispose_BANG_(G__9568_9650);
}
...
var renders_9659 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_9660 = cljs.core.first(cljs.core.vals(renders_9659));
...
if((cljs.core.count(renders_9659) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_9659))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_9660)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_9660], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__9573 = o;
goog.object.set(G__9573,cljs.core.name(k),v);
...
return (function() { 
var G__9711__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
while (G__9712__i < G__9712__a.length) {G__9712__a[G__9712__i] = arguments[G__9712__i + 0]; ++G__9712__i;}
  args = new cljs.core.IndexedSeq(G__9712__a,0,null);
} 
...
var vec__9576 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9576,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9576,(1),null);
...
var G__9580 = goog.object.get(reagent_state,"cljsRatom");
if((G__9580 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__9580);
}
});
}),[]);
