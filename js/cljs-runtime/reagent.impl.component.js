...
return G__9771__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__9773 = c;
...
while (G__9823__i < G__9823__a.length) {G__9823__a[G__9823__i] = arguments[G__9823__i + 0]; ++G__9823__i;}
  args = new cljs.core.IndexedSeq(G__9823__a,0,null);
} 
...
var or__4126__auto__ = (function (){var G__9777 = c;
var G__9777__$1 = (((G__9777 == null))?null:G__9777.constructor);
if((G__9777__$1 == null)){
return null;
} else {
return G__9777__$1.displayName;
}
})();
...
var G__9780 = c;
var G__9780__$1 = (((G__9780 == null))?null:G__9780.constructor);
if((G__9780__$1 == null)){
return null;
} else {
return G__9780__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__9784 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__9785 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__9785);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__9784);
}});
...
var c = this;
var G__9795_9834 = goog.object.get(c,"cljsRatom");
if((G__9795_9834 == null)){
} else {
reagent.ratom.dispose_BANG_(G__9795_9834);
}
...
var renders_9835 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_9836 = cljs.core.first(cljs.core.vals(renders_9835));
...
if((cljs.core.count(renders_9835) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_9835))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_9836)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_9836], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__9797 = o;
goog.object.set(G__9797,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__9803 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__9804 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__9804);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__9803);
}});
...
var vec__9809 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9809,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9809,(1),null);
...
var G__9812 = goog.object.get(reagent_state,"cljsRatom");
if((G__9812 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__9812);
}
});
}),[]);
