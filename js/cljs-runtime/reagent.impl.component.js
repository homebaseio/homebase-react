...
var c = this;
var G__9876_9905 = goog.object.get(c,"cljsRatom");
if((G__9876_9905 == null)){
} else {
reagent.ratom.dispose_BANG_(G__9876_9905);
}
...
var renders_9906 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_9907 = cljs.core.first(cljs.core.vals(renders_9906));
...
if((cljs.core.count(renders_9906) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_9906))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_9907)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_9907], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__9879 = o;
goog.object.set(G__9879,cljs.core.name(k),v);
...
var vec__9884 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9884,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9884,(1),null);
...
var G__9887 = goog.object.get(reagent_state,"cljsRatom");
if((G__9887 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__9887);
}
});
}),[]);
