...
while (G__9747__i < G__9747__a.length) {G__9747__a[G__9747__i] = arguments[G__9747__i + 0]; ++G__9747__i;}
  args = new cljs.core.IndexedSeq(G__9747__a,0,null);
} 
...
var or__4126__auto__ = (function (){var G__9688 = c;
var G__9688__$1 = (((G__9688 == null))?null:G__9688.constructor);
if((G__9688__$1 == null)){
return null;
} else {
return G__9688__$1.displayName;
}
})();
...
var G__9694 = c;
var G__9694__$1 = (((G__9694 == null))?null:G__9694.constructor);
if((G__9694__$1 == null)){
return null;
} else {
return G__9694__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__9697 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__9698 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__9698);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__9697);
}});
...
var c = this;
var G__9710_9766 = goog.object.get(c,"cljsRatom");
if((G__9710_9766 == null)){
} else {
reagent.ratom.dispose_BANG_(G__9710_9766);
}
...
var renders_9767 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_9768 = cljs.core.first(cljs.core.vals(renders_9767));
...
if((cljs.core.count(renders_9767) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_9767))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_9768)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_9768], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
while (G__9783__i < G__9783__a.length) {G__9783__a[G__9783__i] = arguments[G__9783__i + 0]; ++G__9783__i;}
  args = new cljs.core.IndexedSeq(G__9783__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__9722 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__9723 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__9723);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__9722);
}});
...
var G__9736 = goog.object.get(reagent_state,"cljsRatom");
if((G__9736 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__9736);
}
});
}),[]);
