...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__18405 = c;
var G__18405__$1 = (((G__18405 == null))?null:G__18405.prototype);
if((G__18405__$1 == null)){
return null;
} else {
return G__18405__$1.reagentRender;
}
})() == null)))));
});
...
return (function() { 
var G__18443__delegate = function (args){
...
while (G__18444__i < G__18444__a.length) {G__18444__a[G__18444__i] = arguments[G__18444__i + 0]; ++G__18444__i;}
  args = new cljs.core.IndexedSeq(G__18444__a,0,null);
} 
...
var c = this;
var G__18424_18452 = goog.object.get(c,"cljsRatom");
if((G__18424_18452 == null)){
} else {
reagent.ratom.dispose_BANG_(G__18424_18452);
}
...
var renders_18457 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_18458 = cljs.core.first(cljs.core.vals(renders_18457));
...
if((cljs.core.count(renders_18457) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_18457))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_18458)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_18458], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__18427 = o;
goog.object.set(G__18427,cljs.core.name(k),v);
...
return (function() { 
var G__18488__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
while (G__18489__i < G__18489__a.length) {G__18489__a[G__18489__i] = arguments[G__18489__i + 0]; ++G__18489__i;}
  args = new cljs.core.IndexedSeq(G__18489__a,0,null);
} 
...
var args = cljs.core.seq(arglist__18490);
...
var _STAR_current_component_STAR__orig_val__18434 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__18435 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__18435);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__18434);
}});
...
var vec__18436 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18436,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18436,(1),null);
...
var G__18439 = goog.object.get(reagent_state,"cljsRatom");
if((G__18439 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__18439);
}
});
}),[]);
