...
return G__9868__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__9870 = c;
var G__9870__$1 = (((G__9870 == null))?null:G__9870.prototype);
if((G__9870__$1 == null)){
return null;
} else {
return G__9870__$1.render;
}
})() == null)))));
});
...
while (G__9953__i < G__9953__a.length) {G__9953__a[G__9953__i] = arguments[G__9953__i + 0]; ++G__9953__i;}
  args = new cljs.core.IndexedSeq(G__9953__a,0,null);
} 
...
var c = this;
var G__9889_9962 = goog.object.get(c,"cljsRatom");
if((G__9889_9962 == null)){
} else {
reagent.ratom.dispose_BANG_(G__9889_9962);
}
...
var renders_9963 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_9964 = cljs.core.first(cljs.core.vals(renders_9963));
...
if((cljs.core.count(renders_9963) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_9963))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_9964)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_9964], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__9901 = o;
goog.object.set(G__9901,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__9919 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__9920 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__9920);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__9919);
}});
...
var vec__9928 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9928,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9928,(1),null);
...
var G__9931 = goog.object.get(reagent_state,"cljsRatom");
if((G__9931 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__9931);
}
});
}),[]);
