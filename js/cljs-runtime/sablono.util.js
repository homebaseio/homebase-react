...
var sablono$util$ToString$to_str$dyn_13854 = (function (x){
...
return sablono$util$ToString$to_str$dyn_13854(x);
}
});
...
var sablono$util$ToURI$to_uri$dyn_13855 = (function (x){
var x__4428__auto__ = (((x == null))?null:x);
...
return sablono$util$ToURI$to_uri$dyn_13855(x);
}
});
...
var len__4736__auto___13856 = arguments.length;
var i__4737__auto___13857 = (0);
while(true){
if((i__4737__auto___13857 < len__4736__auto___13856)){
args__4742__auto__.push((arguments[i__4737__auto___13857]));

var G__13858 = (i__4737__auto___13857 + (1));
i__4737__auto___13857 = G__13858;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.util.as_str.cljs$lang$applyTo = (function (seq13828){
...
var vec__13835 = cljs.core.name(k).split("-");
var seq__13836 = cljs.core.seq(vec__13835);
var first__13837 = cljs.core.first(seq__13836);
var seq__13836__$1 = cljs.core.next(seq__13836);
var first_word = first__13837;
var words = seq__13836__$1;
...
var m__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__13845){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__13849,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__13849;
}
} else {
