...
var sablono$util$ToString$to_str$dyn_14105 = (function (x){
...
return sablono$util$ToString$to_str$dyn_14105(x);
}
});
...
var sablono$util$ToURI$to_uri$dyn_14106 = (function (x){
var x__4428__auto__ = (((x == null))?null:x);
...
return sablono$util$ToURI$to_uri$dyn_14106(x);
}
});
...
/** @this {Function} */
(sablono.util.as_str.cljs$lang$applyTo = (function (seq14096){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq14096));
}));
...
var vec__14097 = cljs.core.name(k).split("-");
...
var first_word = first__14099;
var words = seq__14098__$1;
...
var m__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__14100){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__14104,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__14104;
}
} else {
