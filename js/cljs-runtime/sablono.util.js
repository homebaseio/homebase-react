...
var sablono$util$ToString$to_str$dyn_12530 = (function (x){
...
return sablono$util$ToString$to_str$dyn_12530(x);
}
});
...
var sablono$util$ToURI$to_uri$dyn_12531 = (function (x){
var x__4428__auto__ = (((x == null))?null:x);
...
return sablono$util$ToURI$to_uri$dyn_12531(x);
}
});
...
var len__4736__auto___12532 = arguments.length;
var i__4737__auto___12533 = (0);
while(true){
if((i__4737__auto___12533 < len__4736__auto___12532)){
args__4742__auto__.push((arguments[i__4737__auto___12533]));

var G__12534 = (i__4737__auto___12533 + (1));
i__4737__auto___12533 = G__12534;
continue;
} else {
}
break;
...
var vec__12467 = cljs.core.name(k).split("-");
...
var first_word = first__12469;
var words = seq__12468__$1;
...
var m__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__12470){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__12474,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__12474;
}
} else {
