...
var sablono$util$ToString$to_str$dyn_12522 = (function (x){
...
return sablono$util$ToString$to_str$dyn_12522(x);
}
});
...
var sablono$util$ToURI$to_uri$dyn_12530 = (function (x){
var x__4428__auto__ = (((x == null))?null:x);
...
return sablono$util$ToURI$to_uri$dyn_12530(x);
}
});
...
var len__4736__auto___12531 = arguments.length;
var i__4737__auto___12532 = (0);
while(true){
if((i__4737__auto___12532 < len__4736__auto___12531)){
args__4742__auto__.push((arguments[i__4737__auto___12532]));

var G__12533 = (i__4737__auto___12532 + (1));
i__4737__auto___12532 = G__12533;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.util.as_str.cljs$lang$applyTo = (function (seq12419){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq12419));
}));
...
var vec__12441 = cljs.core.name(k).split("-");
var seq__12442 = cljs.core.seq(vec__12441);
var first__12443 = cljs.core.first(seq__12442);
var seq__12442__$1 = cljs.core.next(seq__12442);
var first_word = first__12443;
var words = seq__12442__$1;
...
var m__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__12444){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__12448,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__12448;
}
} else {
