...
var sablono$util$ToString$to_str$dyn_13170 = (function (x){
...
return sablono$util$ToString$to_str$dyn_13170(x);
}
});
...
var sablono$util$ToURI$to_uri$dyn_13171 = (function (x){
var x__4428__auto__ = (((x == null))?null:x);
...
return sablono$util$ToURI$to_uri$dyn_13171(x);
}
});
...
var G__13177 = (i__4737__auto___13175 + (1));
i__4737__auto___13175 = G__13177;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.util.as_str.cljs$lang$applyTo = (function (seq13112){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq13112));
}));
...
var vec__13113 = cljs.core.name(k).split("-");
...
var first_word = first__13115;
var words = seq__13114__$1;
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__13131,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__13131;
}
} else {
