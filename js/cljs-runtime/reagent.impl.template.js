...
var G__10005 = o;
goog.object.set(G__10005,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__10009 = o;
goog.object.set(G__10009,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__10010 = props;
var G__10010__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10010,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10010);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10010__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__10019 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10019,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__10019;
}
})(),id_class);
...
var G__10020 = (cljs.core.count(argv) - first_child);
switch (G__10020) {
case (0):
...
var vec__10033 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10033,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10033,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10033,(2),null);
...
var ctx = ({});
var vec__10056 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10056,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10056,(1),null);
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template10063 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template10063 = (function (opts,id,fn_to_element,meta10064){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template10063.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_10065,meta10064__$1){
var self__ = this;
var _10065__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template10063(self__.opts,self__.id,self__.fn_to_element,meta10064__$1));
}));

(reagent.impl.template.t_reagent$impl$template10063.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_10065){
var self__ = this;
var _10065__$1 = this;
return self__.meta10064;
}));

(reagent.impl.template.t_reagent$impl$template10063.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template10063.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template10063.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template10063.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template10063.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta10064","meta10064",2009657423,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template10063.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template10063.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template10063");

(reagent.impl.template.t_reagent$impl$template10063.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template10063");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template10063.
 */
reagent.impl.template.__GT_t_reagent$impl$template10063 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template10063(opts__$1,id__$1,fn_to_element__$1,meta10064){
return (new reagent.impl.template.t_reagent$impl$template10063(opts__$1,id__$1,fn_to_element__$1,meta10064));
});

}

return (new reagent.impl.template.t_reagent$impl$template10063(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
