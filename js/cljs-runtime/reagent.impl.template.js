...
var G__18529 = o;
goog.object.set(G__18529,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__18547__delegate = function (args){
...
while (G__18548__i < G__18548__a.length) {G__18548__a[G__18548__i] = arguments[G__18548__i + 0]; ++G__18548__i;}
  args = new cljs.core.IndexedSeq(G__18548__a,0,null);
} 
...
var G__18530 = o;
goog.object.set(G__18530,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__18556__i < G__18556__a.length) {G__18556__a[G__18556__i] = arguments[G__18556__i + 0]; ++G__18556__i;}
  args = new cljs.core.IndexedSeq(G__18556__a,0,null);
} 
return G__18554__delegate.call(this,args);};
G__18554.cljs$lang$maxFixedArity = 0;
G__18554.cljs$lang$applyTo = (function (arglist__18557){
var args = cljs.core.seq(arglist__18557);
...
var G__18531 = props;
var G__18531__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18531,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__18531);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18531__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__18532 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18532,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__18532;
}
})(),id_class);
...
var G__18533 = (cljs.core.count(argv) - first_child);
switch (G__18533) {
case (0):
...
var vec__18534 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18534,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18534,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18534,(2),null);
...
var temp__5739__auto___18564 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___18564 == null)){
} else {
var key_18565 = temp__5739__auto___18564;
(jsprops.key = key_18565);
}
...
var temp__5739__auto___18567 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___18567 == null)){
} else {
var key_18568 = temp__5739__auto___18567;
(jsprops.key = key_18568);
}
...
var temp__5739__auto___18569 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___18569 == null)){
} else {
var key_18570 = temp__5739__auto___18569;
(jsprops.key = key_18570);
}
...
var temp__5739__auto___18571 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___18571 == null)){
} else {
var key_18572 = temp__5739__auto___18571;
(jsprops.key = key_18572);
}
...
var temp__5739__auto___18573 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___18573 == null)){
} else {
var key_18574 = temp__5739__auto___18573;
(jsprops.key = key_18574);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18537_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__18537_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__18538 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18538,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18538,(1),null);
...
break;
default:
var G__18576 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__18577 = compiler;
v = G__18576;
compiler = G__18577;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template18544 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template18544 = (function (opts,id,fn_to_element,meta18545){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template18544.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_18546,meta18545__$1){
var self__ = this;
var _18546__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template18544(self__.opts,self__.id,self__.fn_to_element,meta18545__$1));
}));

(reagent.impl.template.t_reagent$impl$template18544.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_18546){
var self__ = this;
var _18546__$1 = this;
return self__.meta18545;
}));

(reagent.impl.template.t_reagent$impl$template18544.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template18544.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template18544.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template18544.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template18544.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta18545","meta18545",81075151,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template18544.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template18544.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template18544");

(reagent.impl.template.t_reagent$impl$template18544.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template18544");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template18544.
 */
reagent.impl.template.__GT_t_reagent$impl$template18544 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template18544(opts__$1,id__$1,fn_to_element__$1,meta18545){
return (new reagent.impl.template.t_reagent$impl$template18544(opts__$1,id__$1,fn_to_element__$1,meta18545));
});

}

return (new reagent.impl.template.t_reagent$impl$template18544(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
