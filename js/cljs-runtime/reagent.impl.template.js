...
var G__10017 = o;
goog.object.set(G__10017,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__10061__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__10062__i < G__10062__a.length) {G__10062__a[G__10062__i] = arguments[G__10062__i + 0]; ++G__10062__i;}
  args = new cljs.core.IndexedSeq(G__10062__a,0,null);
} 
...
var G__10018 = props;
var G__10018__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10018,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10018);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10018__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__10031 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10031,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__10031;
}
})(),id_class);
...
var G__10032 = (cljs.core.count(argv) - first_child);
switch (G__10032) {
case (0):
...
var temp__5739__auto___10069 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___10069 == null)){
} else {
var key_10070 = temp__5739__auto___10069;
(jsprops.key = key_10070);
}
...
var temp__5739__auto___10071 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___10071 == null)){
} else {
var key_10072 = temp__5739__auto___10071;
(jsprops.key = key_10072);
}
...
var temp__5739__auto___10073 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___10073 == null)){
} else {
var key_10074 = temp__5739__auto___10073;
(jsprops.key = key_10074);
}
...
var temp__5739__auto___10075 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___10075 == null)){
} else {
var key_10076 = temp__5739__auto___10075;
(jsprops.key = key_10076);
}
...
var temp__5739__auto___10077 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10036_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__10036_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__10040 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10040,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10040,(1),null);
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template10052 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template10052 = (function (opts,id,fn_to_element,meta10053){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template10052.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_10054,meta10053__$1){
var self__ = this;
var _10054__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template10052(self__.opts,self__.id,self__.fn_to_element,meta10053__$1));
}));

(reagent.impl.template.t_reagent$impl$template10052.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_10054){
var self__ = this;
var _10054__$1 = this;
return self__.meta10053;
}));

(reagent.impl.template.t_reagent$impl$template10052.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template10052.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template10052.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template10052.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template10052.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta10053","meta10053",-1874567741,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template10052.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template10052.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template10052");

(reagent.impl.template.t_reagent$impl$template10052.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template10052");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template10052.
 */
reagent.impl.template.__GT_t_reagent$impl$template10052 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template10052(opts__$1,id__$1,fn_to_element__$1,meta10053){
return (new reagent.impl.template.t_reagent$impl$template10052(opts__$1,id__$1,fn_to_element__$1,meta10053));
});

}

return (new reagent.impl.template.t_reagent$impl$template10052(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
