...
var G__9966 = o;
goog.object.set(G__9966,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__10007__i < G__10007__a.length) {G__10007__a[G__10007__i] = arguments[G__10007__i + 0]; ++G__10007__i;}
  args = new cljs.core.IndexedSeq(G__10007__a,0,null);
} 
...
var G__9973 = o;
goog.object.set(G__9973,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__10010__i < G__10010__a.length) {G__10010__a[G__10010__i] = arguments[G__10010__i + 0]; ++G__10010__i;}
  args = new cljs.core.IndexedSeq(G__10010__a,0,null);
} 
...
var G__9976 = props;
var G__9976__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9976,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__9976);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9976__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__9979 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9979,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__9979;
}
})(),id_class);
...
var G__9980 = (cljs.core.count(argv) - first_child);
switch (G__9980) {
case (0):
...
var vec__9981 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9981,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9981,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9981,(2),null);
...
var temp__5739__auto___10019 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___10019 == null)){
} else {
var key_10020 = temp__5739__auto___10019;
(jsprops.key = key_10020);
}
...
var temp__5739__auto___10021 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___10021 == null)){
} else {
var key_10022 = temp__5739__auto___10021;
(jsprops.key = key_10022);
}
...
var temp__5739__auto___10023 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___10023 == null)){
} else {
var key_10024 = temp__5739__auto___10023;
(jsprops.key = key_10024);
}
...
var temp__5739__auto___10025 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___10025 == null)){
} else {
var key_10026 = temp__5739__auto___10025;
(jsprops.key = key_10026);
}
...
var temp__5739__auto___10027 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___10027 == null)){
} else {
var key_10028 = temp__5739__auto___10027;
(jsprops.key = key_10028);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9988_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__9988_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__9991 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9991,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9991,(1),null);
...
break;
default:
var G__10030 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__10031 = compiler;
v = G__10030;
compiler = G__10031;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template9997 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template9997 = (function (opts,id,fn_to_element,meta9998){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template9997.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_9999,meta9998__$1){
var self__ = this;
var _9999__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template9997(self__.opts,self__.id,self__.fn_to_element,meta9998__$1));
}));

(reagent.impl.template.t_reagent$impl$template9997.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_9999){
var self__ = this;
var _9999__$1 = this;
return self__.meta9998;
}));

(reagent.impl.template.t_reagent$impl$template9997.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template9997.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template9997.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template9997.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template9997.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta9998","meta9998",926948179,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template9997.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template9997.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template9997");

(reagent.impl.template.t_reagent$impl$template9997.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template9997");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template9997.
 */
reagent.impl.template.__GT_t_reagent$impl$template9997 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template9997(opts__$1,id__$1,fn_to_element__$1,meta9998){
return (new reagent.impl.template.t_reagent$impl$template9997(opts__$1,id__$1,fn_to_element__$1,meta9998));
});

}

return (new reagent.impl.template.t_reagent$impl$template9997(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
