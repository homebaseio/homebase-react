...
var G__9920 = o;
goog.object.set(G__9920,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__9979__i < G__9979__a.length) {G__9979__a[G__9979__i] = arguments[G__9979__i + 0]; ++G__9979__i;}
  args = new cljs.core.IndexedSeq(G__9979__a,0,null);
} 
...
var G__9931 = o;
goog.object.set(G__9931,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__9932 = props;
var G__9932__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9932,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__9932);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9932__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__9933 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9933,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__9933;
}
})(),id_class);
...
var G__9934 = (cljs.core.count(argv) - first_child);
switch (G__9934) {
case (0):
...
var vec__9938 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9938,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9938,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9938,(2),null);
...
var temp__5739__auto___10005 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___10005 == null)){
} else {
var key_10006 = temp__5739__auto___10005;
(jsprops.key = key_10006);
}
...
var temp__5739__auto___10007 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___10007 == null)){
} else {
var key_10008 = temp__5739__auto___10007;
...
var temp__5739__auto___10009 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___10009 == null)){
} else {
var key_10010 = temp__5739__auto___10009;
(jsprops.key = key_10010);
}
...
var temp__5739__auto___10011 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___10011 == null)){
} else {
var key_10012 = temp__5739__auto___10011;
(jsprops.key = key_10012);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9955_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__9955_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__9956 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9956,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9956,(1),null);
...
var G__9965 = tag;
var G__9965__$1 = (((G__9965 instanceof cljs.core.Keyword))?G__9965.fqn:null);
switch (G__9965__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template9967 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template9967 = (function (opts,id,fn_to_element,meta9968){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template9967.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_9969,meta9968__$1){
var self__ = this;
var _9969__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template9967(self__.opts,self__.id,self__.fn_to_element,meta9968__$1));
}));

(reagent.impl.template.t_reagent$impl$template9967.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_9969){
var self__ = this;
var _9969__$1 = this;
return self__.meta9968;
}));

(reagent.impl.template.t_reagent$impl$template9967.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template9967.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template9967.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template9967.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template9967.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta9968","meta9968",1238704427,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template9967.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template9967.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template9967");

(reagent.impl.template.t_reagent$impl$template9967.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template9967");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template9967.
 */
reagent.impl.template.__GT_t_reagent$impl$template9967 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template9967(opts__$1,id__$1,fn_to_element__$1,meta9968){
return (new reagent.impl.template.t_reagent$impl$template9967(opts__$1,id__$1,fn_to_element__$1,meta9968));
});

}

return (new reagent.impl.template.t_reagent$impl$template9967(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
