...
var i_8952 = (self__.level + (1));
while(true){
if((i_8952 <= (new_level + (1)))){
(update[i_8952] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_8954 = (update[i]).forward;
(x__$2.forward[i] = (links_8954[i]));
