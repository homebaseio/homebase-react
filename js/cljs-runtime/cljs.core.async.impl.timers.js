...
var i_10602 = (self__.level + (1));
while(true){
if((i_10602 <= (new_level + (1)))){
(update[i_10602] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_10604 = (update[i]).forward;
(x__$2.forward[i] = (links_10604[i]));
...
var i_10606 = (0);
while(true){
if((i_10606 <= self__.level)){
var links_10607 = (update[i_10606]).forward;
if((x__$1 === (((i_10606 < links_10607.length))?(links_10607[i_10606]):null))){
(links_10607[i_10606] = (x__$1.forward[i_10606]));

var G__10608 = (i_10606 + (1));
i_10606 = G__10608;
continue;
} else {
var G__10610 = (i_10606 + (1));
i_10606 = G__10610;
continue;
}
} else {
...
var G__10623 = nx;
var G__10624 = (level__$1 - (1));
x = G__10623;
level__$1 = G__10624;
continue;
} else {
var G__10625 = x;
var G__10626 = (level__$1 - (1));
x = G__10625;
level__$1 = G__10626;
continue;
}
