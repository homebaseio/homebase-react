...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10364 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10364(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10365 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10365(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10366 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10366(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10367 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10367(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10368 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10368(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10369 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10369(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10371 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10371(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10372 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10372(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10373 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10373(b,itm);
}
});
