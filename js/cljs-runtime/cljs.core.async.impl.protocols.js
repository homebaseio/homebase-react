...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_8734 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_8734(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_8735 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_8735(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_8736 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_8736(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_8737 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_8737(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_8739 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_8739(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_8743 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_8743(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_8744 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_8744(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_8745 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_8745(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_8746 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_8746(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_8748 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_8748(b,itm);
}
});
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_8750(b);
}
});
