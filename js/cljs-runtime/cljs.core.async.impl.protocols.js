...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_8757 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_8757(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_8760 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_8760(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_8761 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_8761(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_8762 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_8762(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_8763 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_8763(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_8764 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_8764(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_8765 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_8765(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_8770 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_8770(b);
}
});
