...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10068 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10068(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10069 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10069(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10070 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10070(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10071 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10071(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10072 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10072(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10073 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10073(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10078 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10078(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10087 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10087(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10088 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10088(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10089 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10089(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10090 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10090(b);
}
});
