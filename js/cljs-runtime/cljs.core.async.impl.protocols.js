...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10297 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10297(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10298 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10298(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10299 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10299(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10301 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10301(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10302 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10302(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10304 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10304(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10306 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10306(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10309 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10309(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10312 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10312(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10316 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10316(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10321 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10321(b);
}
});
