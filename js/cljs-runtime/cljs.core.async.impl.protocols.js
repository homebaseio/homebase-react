...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10570 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10570(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10571 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10571(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10572 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10572(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10573 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10573(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10574 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10574(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10575 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10575(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10576 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10576(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10577 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10577(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10578 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10578(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10579 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10579(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10580 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10580(b);
}
});
