...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_8733 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_8733(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_8737 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_8737(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_8743 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_8743(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_8744 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_8744(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_8745 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_8745(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_8746 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_8746(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_8747 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_8747(b);
}
});
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_8749(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_8755 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_8755(b);
}
});
