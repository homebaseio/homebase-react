...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_8744 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_8744(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_8750 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_8750(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_8751 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_8751(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_8752 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_8752(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_8753 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_8753(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_8754 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_8754(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_8756 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_8756(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_8757 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_8757(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_8758 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_8758(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_8760 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_8760(b);
}
});
