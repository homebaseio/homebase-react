...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10439 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10439(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10440 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10440(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10441 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10441(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10442 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10442(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10443 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10443(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10444 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10444(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10445 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10445(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10446 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10446(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10447 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10447(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10448 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10448(b);
}
});
