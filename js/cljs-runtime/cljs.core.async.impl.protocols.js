...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10438 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10438(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10442 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10442(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10443 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10443(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10444 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10444(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10445 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10445(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10446 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10446(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10447 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10447(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10448 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10448(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10449 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10449(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10450 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10450(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10451 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10451(b);
}
});
