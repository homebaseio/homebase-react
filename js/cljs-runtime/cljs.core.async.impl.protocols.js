...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10414 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10414(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10415 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10415(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10416 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10416(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10417 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10417(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10418 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10418(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10419 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10419(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10420 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10420(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10422 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10422(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10428 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10428(b);
}
});
...
var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10433 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10433(b);
}
});
