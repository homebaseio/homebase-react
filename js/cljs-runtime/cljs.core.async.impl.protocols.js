...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_8801 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_8801(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_8803 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_8803(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_8805 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_8805(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_8806 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_8806(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_8809 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_8809(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_8811 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_8811(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_8813 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_8813(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_8814 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_8814(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_8815 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_8815(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_8824 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_8824(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_8827 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_8827(b);
}
});
