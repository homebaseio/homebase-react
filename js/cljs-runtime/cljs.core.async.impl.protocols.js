...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10342 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10342(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10343 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10343(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10347 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10347(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10351 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10351(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10352 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10352(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10354 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10354(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10370 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10370(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10376 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10376(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10382 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10382(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10386 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10386(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10391 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10391(b);
}
});
