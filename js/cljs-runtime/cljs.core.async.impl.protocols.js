...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10142 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10142(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10144 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10144(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10145 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10145(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10146 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10146(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10147 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10147(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10148 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10148(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10149 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10149(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10151 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10151(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10152 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10152(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10153 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10153(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10154 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10154(b);
}
});
