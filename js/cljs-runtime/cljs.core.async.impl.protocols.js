...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10179 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10179(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10180 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10180(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10181 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10181(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10182 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10182(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10183 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10183(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10187 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10187(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10188 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10188(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10189 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10189(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10190 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10190(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10191 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10191(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10193 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10193(b);
}
});
