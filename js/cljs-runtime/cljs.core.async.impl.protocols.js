...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10229 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10229(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10233 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10233(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10236 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10236(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10239 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10239(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10240 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10240(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10241 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10241(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10242 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10242(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10243 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10243(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10244 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10244(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10245 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10245(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10246 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10246(b);
}
});
