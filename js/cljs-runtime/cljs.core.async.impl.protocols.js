...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_8719 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_8719(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_8721 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_8721(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_8723 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_8723(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_8725 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_8725(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_8726 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_8726(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_8729 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_8729(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_8734 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_8734(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_8735 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_8735(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_8736 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_8736(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_8738 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_8738(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_8739 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_8739(b);
}
});
