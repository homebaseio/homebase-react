...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10536 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10536(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10537 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10537(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10538 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10538(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10539 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10539(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10540 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10540(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10541 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10541(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10542 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10542(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10543 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10543(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10544 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10544(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10545 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10545(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10546 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10546(b);
}
});
