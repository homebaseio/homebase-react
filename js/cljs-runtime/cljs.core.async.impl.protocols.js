...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10543 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10543(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10544 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10544(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10546 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10546(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10555 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10555(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10565 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10565(h);
}
});
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10571(h);
}
});
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10572(h);
}
});
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10573(b);
}
});
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10574(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10578 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10578(b,itm);
}
});
