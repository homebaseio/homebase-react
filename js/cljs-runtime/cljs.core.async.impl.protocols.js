...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10087 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10087(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10090 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10090(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10092 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10092(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10093 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10093(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10094 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10094(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10095 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10095(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10096 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10096(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10097 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10097(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10098 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10098(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10099 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10099(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10100 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10100(b);
}
});
