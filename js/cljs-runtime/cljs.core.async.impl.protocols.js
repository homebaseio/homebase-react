...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10456 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10456(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10460 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10460(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10461 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10461(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10462 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10462(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10463 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10463(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10464 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10464(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10465 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10465(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10466 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10466(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10467 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10467(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10468 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10468(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10469 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10469(b);
}
});
