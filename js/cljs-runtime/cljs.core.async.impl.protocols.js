...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10458(port,fn1_handler);
}
});
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10459(port,val,fn1_handler);
}
});
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10460(chan);
}
});
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10461(chan);
}
});
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10462(h);
}
});
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10463(h);
}
});
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10464(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10475 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10475(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10490 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10490(b);
}
});
