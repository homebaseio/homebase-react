...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_8771 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_8771(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_8772 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_8772(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_8773 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_8773(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_8774 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_8774(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_8775 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_8775(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_8776 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_8776(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_8777 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_8777(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_8778 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_8778(b);
}
});
