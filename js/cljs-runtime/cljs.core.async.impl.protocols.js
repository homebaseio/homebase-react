...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_8727 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_8727(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_8732 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_8732(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_8733 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_8733(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_8734 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_8734(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_8735 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_8735(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_8736 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_8736(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_8737 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_8737(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_8738 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_8738(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_8739 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_8739(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_8740 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_8740(b,itm);
}
});
