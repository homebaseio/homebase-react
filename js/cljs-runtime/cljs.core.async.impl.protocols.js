...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_8791 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_8791(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_8802 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_8802(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_8803 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_8803(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_8805 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_8805(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_8807 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_8807(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_8808 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_8808(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_8810 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_8810(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_8812 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_8812(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_8813 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_8813(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_8816 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_8816(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_8820 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_8820(b);
}
});
