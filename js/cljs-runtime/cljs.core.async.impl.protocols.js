...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10533 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10533(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10535 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10535(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10537 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10537(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10545 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10545(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10546 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10546(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10547 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10547(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10548 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10548(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10549 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10549(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10550 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10550(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10551 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10551(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10552 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10552(b);
}
});
