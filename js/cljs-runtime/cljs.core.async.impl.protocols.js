...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10166 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10166(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10167 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10167(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10170 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10170(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10174 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10174(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10176 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10176(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10179 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10179(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10180 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10180(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10181 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10181(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10182 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10182(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10183 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10183(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10185 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10185(b);
}
});
