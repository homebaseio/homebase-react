...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__13249){
var vec__13250 = p__13249;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13250,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13250,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__13289_SHARP_){
return (((p1__13289_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__13289_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__13290,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__13290;
}
});
...
var len__4736__auto___13327 = arguments.length;
var i__4737__auto___13328 = (0);
while(true){
if((i__4737__auto___13328 < len__4736__auto___13327)){
args__4742__auto__.push((arguments[i__4737__auto___13328]));

var G__13329 = (i__4737__auto___13328 + (1));
i__4737__auto___13328 = G__13329;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq13291){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq13291));
}));
...
var vec__13309 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__13313 = cljs.core.ffirst(matches);
var fexpr__13312 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__13312.cljs$core$IFn$_invoke$arity$1 ? fexpr__13312.cljs$core$IFn$_invoke$arity$1(G__13313) : fexpr__13312.call(null,G__13313));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13309,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13309,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__13307_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__13307_SHARP_))){
return p1__13307_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__13308_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__13308_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__13315){
...
var tag = first__13318;
var content = seq__13317__$1;
...
var vec__13319 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13319,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13319,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13319,(2),null);
