...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__13870){
var vec__13871 = p__13870;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13871,(0),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__13897_SHARP_){
return (((p1__13897_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__13897_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__13898,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__13898;
}
});
...
var len__4736__auto___13966 = arguments.length;
var i__4737__auto___13967 = (0);
while(true){
if((i__4737__auto___13967 < len__4736__auto___13966)){
args__4742__auto__.push((arguments[i__4737__auto___13967]));

var G__13968 = (i__4737__auto___13967 + (1));
i__4737__auto___13967 = G__13968;
continue;
} else {
}
break;
...
var G__13900 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13900,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__13900;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq13899){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq13899));
}));
...
var vec__13903 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__13907 = cljs.core.ffirst(matches);
var fexpr__13906 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__13906.cljs$core$IFn$_invoke$arity$1 ? fexpr__13906.cljs$core$IFn$_invoke$arity$1(G__13907) : fexpr__13906.call(null,G__13907));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13903,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13903,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__13901_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__13901_SHARP_))){
return p1__13901_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__13902_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__13902_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__13942){
var vec__13943 = p__13942;
var seq__13944 = cljs.core.seq(vec__13943);
var first__13945 = cljs.core.first(seq__13944);
var seq__13944__$1 = cljs.core.next(seq__13944);
var tag = first__13945;
var content = seq__13944__$1;
...
var vec__13946 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13946,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13946,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13946,(2),null);
