...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__12994){
var vec__12995 = p__12994;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12995,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12995,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__12998_SHARP_){
return (((p1__12998_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__12998_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__12999,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__12999;
}
});
...
var G__13004 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13004,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__13004;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq13000){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq13000));
}));
...
var vec__13007 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__13017 = cljs.core.ffirst(matches);
var fexpr__13016 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__13016.cljs$core$IFn$_invoke$arity$1 ? fexpr__13016.cljs$core$IFn$_invoke$arity$1(G__13017) : fexpr__13016.call(null,G__13017));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13007,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13007,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__13005_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__13005_SHARP_))){
return p1__13005_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__13006_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__13006_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__13077){
var vec__13078 = p__13077;
var seq__13079 = cljs.core.seq(vec__13078);
var first__13080 = cljs.core.first(seq__13079);
var seq__13079__$1 = cljs.core.next(seq__13079);
var tag = first__13080;
var content = seq__13079__$1;
...
var vec__13081 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13081,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13081,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13081,(2),null);
