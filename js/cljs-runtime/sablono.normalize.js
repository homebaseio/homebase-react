...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__12408){
var vec__12409 = p__12408;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12409,(0),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__12435_SHARP_){
return (((p1__12435_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__12435_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__12440,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__12440;
}
});
...
var len__4736__auto___12497 = arguments.length;
var i__4737__auto___12498 = (0);
while(true){
if((i__4737__auto___12498 < len__4736__auto___12497)){
args__4742__auto__.push((arguments[i__4737__auto___12498]));

var G__12499 = (i__4737__auto___12498 + (1));
i__4737__auto___12498 = G__12499;
continue;
} else {
}
break;
...
var G__12444 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12444,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__12444;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq12441){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq12441));
}));
...
var vec__12447 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__12451 = cljs.core.ffirst(matches);
var fexpr__12450 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__12450.cljs$core$IFn$_invoke$arity$1 ? fexpr__12450.cljs$core$IFn$_invoke$arity$1(G__12451) : fexpr__12450.call(null,G__12451));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12447,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12447,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__12445_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__12445_SHARP_))){
return p1__12445_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__12446_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__12446_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__12478){
var vec__12481 = p__12478;
var seq__12482 = cljs.core.seq(vec__12481);
var first__12483 = cljs.core.first(seq__12482);
var seq__12482__$1 = cljs.core.next(seq__12482);
var tag = first__12483;
var content = seq__12482__$1;
...
var vec__12485 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12485,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12485,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12485,(2),null);
