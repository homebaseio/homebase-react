...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__13117){
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__13121_SHARP_){
return (((p1__13121_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__13121_SHARP_ === 'string'));
}),class$)))){
...
var len__4736__auto___13193 = arguments.length;
var i__4737__auto___13194 = (0);
while(true){
if((i__4737__auto___13194 < len__4736__auto___13193)){
args__4742__auto__.push((arguments[i__4737__auto___13194]));

var G__13195 = (i__4737__auto___13194 + (1));
i__4737__auto___13194 = G__13195;
continue;
} else {
}
break;
...
var G__13131 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13131,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__13131;
}
} else {
...
var vec__13140 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__13144 = cljs.core.ffirst(matches);
var fexpr__13143 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__13143.cljs$core$IFn$_invoke$arity$1 ? fexpr__13143.cljs$core$IFn$_invoke$arity$1(G__13144) : fexpr__13143.call(null,G__13144));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13140,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13140,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__13138_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__13138_SHARP_))){
return p1__13138_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__13139_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__13139_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__13185){
...
var tag = first__13188;
var content = seq__13187__$1;
...
var vec__13189 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13189,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13189,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13189,(2),null);
