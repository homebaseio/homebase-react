...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__14110){
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__14114_SHARP_){
return (((p1__14114_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__14114_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__14115,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__14115;
}
});
...
var len__4736__auto___14133 = arguments.length;
var i__4737__auto___14134 = (0);
while(true){
if((i__4737__auto___14134 < len__4736__auto___14133)){
args__4742__auto__.push((arguments[i__4737__auto___14134]));

var G__14135 = (i__4737__auto___14134 + (1));
i__4737__auto___14134 = G__14135;
continue;
} else {
}
break;
...
var G__14117 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14117,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__14117;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq14116){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq14116));
}));
...
var vec__14120 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__14124 = cljs.core.ffirst(matches);
var fexpr__14123 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__14123.cljs$core$IFn$_invoke$arity$1 ? fexpr__14123.cljs$core$IFn$_invoke$arity$1(G__14124) : fexpr__14123.call(null,G__14124));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14120,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14120,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__14118_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__14118_SHARP_))){
return p1__14118_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__14119_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__14119_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__14126){
var vec__14127 = p__14126;
var seq__14128 = cljs.core.seq(vec__14127);
var first__14129 = cljs.core.first(seq__14128);
var seq__14128__$1 = cljs.core.next(seq__14128);
var tag = first__14129;
var content = seq__14128__$1;
...
var vec__14130 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14130,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14130,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14130,(2),null);
