...
var G__17064 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__17064,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint], 0));
} else {
return G__17064;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq17067){
var G__17068 = cljs.core.first(seq17067);
var seq17067__$1 = cljs.core.next(seq17067);
var G__17069 = cljs.core.first(seq17067__$1);
var seq17067__$2 = cljs.core.next(seq17067__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17068,G__17069,seq17067__$2);
}));
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17079__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17079__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17079__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__17078_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__17078_SHARP_));
...
var temp__5735__auto___17157 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___17157)){
var message_17158 = temp__5735__auto___17157;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_17158], 0));
} else {
}
...
var temp__5735__auto___17159 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___17159)){
var message_17160 = temp__5735__auto___17159;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_17160], 0));
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__17105 = output_dir;
if((!(clojure.string.ends_with_QMARK_(output_dir,"/")))){
return [G__17105,"/"].join('');
} else {
return G__17105;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__17117 = exception.stack;
var G__17117__$1 = (((G__17117 == null))?null:clojure.string.split_lines(G__17117));
var G__17117__$2 = (((G__17117__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__17117__$1,depth));
if((G__17117__$2 == null)){
return null;
} else {
return clojure.string.trim(G__17117__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename(stack_element);
var vec__17118 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17118,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17118,(1),null);
var vec__17121 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17121,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17121,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17121,(2),null);
...
var m__$1 = (function (){var G__17124 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__17126 = (function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6292__auto__,temp__5735__auto__){
return (function (){
var G__17127 = cljs.core.rest(fns);
return (cljs.test.run_block.cljs$core$IFn$_invoke$arity$1 ? cljs.test.run_block.cljs$core$IFn$_invoke$arity$1(G__17127) : cljs.test.run_block.call(null,G__17127));
...
return (obj.cljs$core$IFn$_invoke$arity$1 ? obj.cljs$core$IFn$_invoke$arity$1(G__17126) : obj.call(null,G__17126));
} else {
var G__17162 = (function (){var G__17128 = cljs.core.rest(fns);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(obj,G__17128);
} else {
return G__17128;
}
})();
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(G__17129,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
return (function (g){
var G__17132 = (function (){
return (f2.cljs$core$IFn$_invoke$arity$1 ? f2.cljs$core$IFn$_invoke$arity$1(g) : f2.call(null,g));
});
return (f1.cljs$core$IFn$_invoke$arity$1 ? f1.cljs$core$IFn$_invoke$arity$1(G__17132) : f1.call(null,G__17132));
});
});
/**
...
var vec__17133 = fixtures_types();
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17133,(0),null);
var types = vec__17133;
...
var fexpr__17136 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword(null,"async","async",1050769601),new cljs.core.Keyword(null,"fn","fn",-1175266204),new cljs.core.Keyword(null,"sync","sync",-624148946)], null);
return (fexpr__17136.cljs$core$IFn$_invoke$arity$2 ? fexpr__17136.cljs$core$IFn$_invoke$arity$2(type,new cljs.core.Keyword(null,"async","async",1050769601)) : fexpr__17136.call(null,type,new cljs.core.Keyword(null,"async","async",1050769601)));
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__17137){
var vec__17138 = p__17137;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17138,(0),null);
var vars__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17138,(1),null);
return (function (){
return cljs.test.block((function (){var env = cljs.test.get_current_env();
var once_fixtures = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"once-fixtures","once-fixtures",1253947167),ns], null));
var each_fixtures = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"each-fixtures","each-fixtures",802243977),ns], null));
var G__17141 = cljs.test.execution_strategy(once_fixtures,each_fixtures);
...
var G__17143 = (function (){
var seq__17144 = cljs.core.seq(vars__$1);
var chunk__17145 = null;
var count__17146 = (0);
var i__17147 = (0);
while(true){
if((i__17147 < count__17146)){
var v = chunk__17145.cljs$core$IIndexed$_nth$arity$2(null,i__17147);
var temp__5735__auto___17165 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___17165)){
var t_17166 = temp__5735__auto___17165;
var G__17151_17167 = ((function (seq__17144,chunk__17145,count__17146,i__17147,t_17166,temp__5735__auto___17165,v,each_fixture_fn,G__17141,G__17141__$1,env,once_fixtures,each_fixtures,vec__17138,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_17166)));
});})(seq__17144,chunk__17145,count__17146,i__17147,t_17166,temp__5735__auto___17165,v,each_fixture_fn,G__17141,G__17141__$1,env,once_fixtures,each_fixtures,vec__17138,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__17151_17167) : each_fixture_fn.call(null,G__17151_17167));
} else {
}


var G__17168 = seq__17144;
var G__17169 = chunk__17145;
var G__17170 = count__17146;
var G__17171 = (i__17147 + (1));
seq__17144 = G__17168;
chunk__17145 = G__17169;
count__17146 = G__17170;
i__17147 = G__17171;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__17144);
if(temp__5735__auto__){
var seq__17144__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__17144__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__17144__$1);
var G__17172 = cljs.core.chunk_rest(seq__17144__$1);
var G__17173 = c__4556__auto__;
var G__17174 = cljs.core.count(c__4556__auto__);
var G__17175 = (0);
seq__17144 = G__17172;
chunk__17145 = G__17173;
count__17146 = G__17174;
i__17147 = G__17175;
continue;
} else {
var v = cljs.core.first(seq__17144__$1);
var temp__5735__auto___17177__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___17177__$1)){
var t_17178 = temp__5735__auto___17177__$1;
var G__17152_17179 = ((function (seq__17144,chunk__17145,count__17146,i__17147,t_17178,temp__5735__auto___17177__$1,v,seq__17144__$1,temp__5735__auto__,each_fixture_fn,G__17141,G__17141__$1,env,once_fixtures,each_fixtures,vec__17138,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_17178)));
});})(seq__17144,chunk__17145,count__17146,i__17147,t_17178,temp__5735__auto___17177__$1,v,seq__17144__$1,temp__5735__auto__,each_fixture_fn,G__17141,G__17141__$1,env,once_fixtures,each_fixtures,vec__17138,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__17152_17179) : each_fixture_fn.call(null,G__17152_17179));
} else {
}


var G__17181 = cljs.core.next(seq__17144__$1);
var G__17182 = null;
var G__17183 = (0);
var G__17184 = (0);
seq__17144 = G__17181;
chunk__17145 = G__17182;
count__17146 = G__17183;
i__17147 = G__17184;
continue;
}
} else {
...
var fexpr__17142 = cljs.test.join_fixtures(once_fixtures);
