...
var G__17745 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__17745,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint], 0));
} else {
return G__17745;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq17756){
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17797__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17797__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17797__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__17794_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__17794_SHARP_));
...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__17822 = cljs.core.get_global_hierarchy;
return (fexpr__17822.cljs$core$IFn$_invoke$arity$0 ? fexpr__17822.cljs$core$IFn$_invoke$arity$0() : fexpr__17822.call(null));
})());
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__17849 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__17849) : formatter_fn.call(null,G__17849));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__17850 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__17850) : formatter_fn.call(null,G__17850));
})()], 0));
});
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__17854 = output_dir;
if((!(clojure.string.ends_with_QMARK_(output_dir,"/")))){
return [G__17854,"/"].join('');
} else {
return G__17854;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__17856 = exception.stack;
var G__17856__$1 = (((G__17856 == null))?null:clojure.string.split_lines(G__17856));
var G__17856__$2 = (((G__17856__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__17856__$1,depth));
if((G__17856__$2 == null)){
return null;
} else {
return clojure.string.trim(G__17856__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename(stack_element);
var vec__17857 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17857,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17857,(1),null);
var vec__17860 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17860,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17860,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17860,(2),null);
...
var m__$1 = (function (){var G__17863 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__17865 = (function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6292__auto__,temp__5735__auto__){
return (function (){
var G__17866 = cljs.core.rest(fns);
return (cljs.test.run_block.cljs$core$IFn$_invoke$arity$1 ? cljs.test.run_block.cljs$core$IFn$_invoke$arity$1(G__17866) : cljs.test.run_block.call(null,G__17866));
...
return (obj.cljs$core$IFn$_invoke$arity$1 ? obj.cljs$core$IFn$_invoke$arity$1(G__17865) : obj.call(null,G__17865));
} else {
var G__17914 = (function (){var G__17867 = cljs.core.rest(fns);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(obj,G__17867);
} else {
return G__17867;
}
})();
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(G__17868,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
return (function (g){
var G__17873 = (function (){
return (f2.cljs$core$IFn$_invoke$arity$1 ? f2.cljs$core$IFn$_invoke$arity$1(g) : f2.call(null,g));
});
return (f1.cljs$core$IFn$_invoke$arity$1 ? f1.cljs$core$IFn$_invoke$arity$1(G__17873) : f1.call(null,G__17873));
});
});
/**
...
var fexpr__17877 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword(null,"async","async",1050769601),new cljs.core.Keyword(null,"fn","fn",-1175266204),new cljs.core.Keyword(null,"sync","sync",-624148946)], null);
return (fexpr__17877.cljs$core$IFn$_invoke$arity$2 ? fexpr__17877.cljs$core$IFn$_invoke$arity$2(type,new cljs.core.Keyword(null,"async","async",1050769601)) : fexpr__17877.call(null,type,new cljs.core.Keyword(null,"async","async",1050769601)));
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__17878){
var vec__17879 = p__17878;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17879,(0),null);
var vars__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17879,(1),null);
return (function (){
return cljs.test.block((function (){var env = cljs.test.get_current_env();
var once_fixtures = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"once-fixtures","once-fixtures",1253947167),ns], null));
var each_fixtures = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"each-fixtures","each-fixtures",802243977),ns], null));
var G__17890 = cljs.test.execution_strategy(once_fixtures,each_fixtures);
...
var seq__17897 = cljs.core.seq(vars__$1);
var chunk__17898 = null;
var count__17899 = (0);
var i__17900 = (0);
while(true){
if((i__17900 < count__17899)){
var v = chunk__17898.cljs$core$IIndexed$_nth$arity$2(null,i__17900);
...
var G__17903_17919 = ((function (seq__17897,chunk__17898,count__17899,i__17900,t_17918,temp__5735__auto___17917,v,each_fixture_fn,G__17890,G__17890__$1,env,once_fixtures,each_fixtures,vec__17879,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_17918)));
});})(seq__17897,chunk__17898,count__17899,i__17900,t_17918,temp__5735__auto___17917,v,each_fixture_fn,G__17890,G__17890__$1,env,once_fixtures,each_fixtures,vec__17879,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__17903_17919) : each_fixture_fn.call(null,G__17903_17919));
} else {
}


var G__17920 = seq__17897;
var G__17921 = chunk__17898;
var G__17922 = count__17899;
var G__17923 = (i__17900 + (1));
seq__17897 = G__17920;
chunk__17898 = G__17921;
count__17899 = G__17922;
i__17900 = G__17923;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__17897);
if(temp__5735__auto__){
var seq__17897__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__17897__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__17897__$1);
var G__17924 = cljs.core.chunk_rest(seq__17897__$1);
var G__17925 = c__4556__auto__;
var G__17926 = cljs.core.count(c__4556__auto__);
var G__17927 = (0);
seq__17897 = G__17924;
chunk__17898 = G__17925;
count__17899 = G__17926;
i__17900 = G__17927;
continue;
} else {
var v = cljs.core.first(seq__17897__$1);
...
var G__17904_17930 = ((function (seq__17897,chunk__17898,count__17899,i__17900,t_17929,temp__5735__auto___17928__$1,v,seq__17897__$1,temp__5735__auto__,each_fixture_fn,G__17890,G__17890__$1,env,once_fixtures,each_fixtures,vec__17879,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_17929)));
});})(seq__17897,chunk__17898,count__17899,i__17900,t_17929,temp__5735__auto___17928__$1,v,seq__17897__$1,temp__5735__auto__,each_fixture_fn,G__17890,G__17890__$1,env,once_fixtures,each_fixtures,vec__17879,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__17904_17930) : each_fixture_fn.call(null,G__17904_17930));
} else {
}


var G__17931 = cljs.core.next(seq__17897__$1);
var G__17932 = null;
var G__17933 = (0);
var G__17934 = (0);
seq__17897 = G__17931;
chunk__17898 = G__17932;
count__17899 = G__17933;
i__17900 = G__17934;
continue;
}
} else {
...
var fexpr__17895 = cljs.test.join_fixtures(once_fixtures);
return (fexpr__17895.cljs$core$IFn$_invoke$arity$1 ? fexpr__17895.cljs$core$IFn$_invoke$arity$1(G__17896) : fexpr__17895.call(null,G__17896));
})], null);

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__17890__$1)].join('')));
