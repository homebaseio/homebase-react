...
const config$$module$js_gen$todo_example = {schema:{":db/ident":{":db/unique":":db.unique/identity"}, ":todo/project":{":db/valueType":":db.type/ref", ":db/cardinality":":db.cardinality/one"}, ":todo/owner":{":db/valueType":":db.type/ref", ":db/cardinality":":db.cardinality/one"}}, initialData:[{":db/ident":":settings/filters", ":filter/show-completed?":true}, {":db/id":-1, ":user/name":"Stella"}, {":db/id":-2, ":user/name":"Arpegius"}, {":db/id":-3, ":project/name":"Make it"}, {":db/id":-4, ":project/name":"Do it"}, 
{":todo/name":"Fix ship", ":todo/owner":-1, ":todo/project":-3, ":todo/created-at":new Date("2003/11/10")}, {":todo/name":"Go home", ":todo/owner":-2, ":todo/project":-4, ":todo/created-at":new Date("2003/11/9")}]};
...
const Filters$$module$js_gen$todo_example = () => {
  ...
  const [transact] = useTransact$$module$js_gen$todo_example();
  return module$node_modules$react$index.createElement("div", null, module$node_modules$react$index.createElement("label", {htmlFor:":filter/show-completed?"}, "Show Completed?"), module$node_modules$react$index.createElement("input", {type:"checkbox", id:":filter/show-completed?", checked:filters.get(":filter/show-completed?"), onChange:e => transact([{":db/id":filters.get(":db/id"), ":filter/show-completed?":e.target.checked}])}));
};
...
const TodoName$$module$js_gen$todo_example = $jscomp$destructuring$var2 => {
...
const TodoProject$$module$js_gen$todo_example = $jscomp$destructuring$var3 => {
...
const TodoOwner$$module$js_gen$todo_example = $jscomp$destructuring$var4 => {
...
const TodoDelete$$module$js_gen$todo_example = $jscomp$destructuring$var5 => {
