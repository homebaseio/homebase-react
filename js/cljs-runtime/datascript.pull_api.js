...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21102__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21102__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__21105 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__21105__$1 = (((G__21105 == null))?null:cljs.core.persistent_BANG_(G__21105));
if((G__21105__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__21105__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__21106){
...
var frame = first__21109;
var frames = seq__21108__$1;
...
var results = (function (){var G__21110 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__21110,kvps);
} else {
return G__21110;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21113__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21113__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_21161 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_21161,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__21116){
...
var found = cljs.core.not_empty((function (){var G__21120 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__21120);
} else {
return G__21120;
}
})());
...
var as_value = (function (){var G__21122 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__21115_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__21115_SHARP_]);
}),G__21122);
} else {
return G__21122;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__21123 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__21123);
} else {
return G__21123;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__21124 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__21124,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__21124;
}
})());
...
var vec__21125 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21125,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21125,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__21128){
var vec__21129 = p__21128;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21129,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21129,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__21132){
var vec__21133 = p__21132;
var seq__21134 = cljs.core.seq(vec__21133);
var first__21135 = cljs.core.first(seq__21134);
var seq__21134__$1 = cljs.core.next(seq__21134);
var frame = first__21135;
var frames = seq__21134__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__21136){
...
var vec__21141 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21141,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21141,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21144__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21144__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__21146 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__21146,attr,eid);
} else {
return G__21146;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21147__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21147__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__21149){
while(true){
var vec__21150 = p__21149;
var seq__21151 = cljs.core.seq(vec__21150);
var first__21152 = cljs.core.first(seq__21151);
var seq__21151__$1 = cljs.core.next(seq__21151);
var frame = first__21152;
var frames = seq__21151__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__21163 = db;
var G__21164 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__21163;
p__21149 = G__21164;
continue;
}
...
while(true){
var G__21153 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__21153__$1 = (((G__21153 instanceof cljs.core.Keyword))?G__21153.fqn:null);
switch (G__21153__$1) {
case "expand":
var G__21166 = db;
var G__21167 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__21166;
frames = G__21167;
continue;
...
case "expand-rev":
var G__21168 = db;
var G__21169 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__21168;
frames = G__21169;
continue;
...
case "pattern":
var G__21170 = db;
var G__21171 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__21170;
frames = G__21171;
continue;
...
case "recursion":
var G__21172 = db;
var G__21173 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__21172;
frames = G__21173;
continue;
...
var f = first__21156;
var remaining = seq__21155__$1;
var result = (function (){var G__21157 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__21157);
} else {
return G__21157;
}
})();
...
var G__21174 = db;
var G__21175 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__21158 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__21158,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__21158;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21153__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__21159_SHARP_){
return datascript.db.entid_strict(db,p1__21159_SHARP_);
})),eids);
