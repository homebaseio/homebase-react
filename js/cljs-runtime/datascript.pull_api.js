...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21105__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21105__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__21108){
var vec__21109 = p__21108;
var seq__21110 = cljs.core.seq(vec__21109);
var first__21111 = cljs.core.first(seq__21110);
var seq__21110__$1 = cljs.core.next(seq__21110);
var frame = first__21111;
var frames = seq__21110__$1;
...
var results = (function (){var G__21112 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
...
var pattern_21162 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_21162,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
...
var vec__21118 = p__21116;
var seq__21119 = cljs.core.seq(vec__21118);
var first__21120 = cljs.core.first(seq__21119);
var seq__21119__$1 = cljs.core.next(seq__21119);
var parent = first__21120;
var frames = seq__21119__$1;
...
var found = cljs.core.not_empty((function (){var G__21121 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__21121);
} else {
return G__21121;
}
})());
...
var vec__21140 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21140,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21140,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21143__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21143__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__21145 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__21145,attr,eid);
} else {
return G__21145;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21146__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21146__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var G__21164 = db;
var G__21165 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__21164;
p__21149 = G__21165;
continue;
}
...
case "expand":
var G__21167 = db;
var G__21168 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__21167;
frames = G__21168;
continue;
...
case "expand-rev":
var G__21169 = db;
var G__21170 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__21169;
frames = G__21170;
continue;
...
case "pattern":
var G__21171 = db;
var G__21172 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__21171;
frames = G__21172;
continue;
...
case "recursion":
var G__21173 = db;
var G__21174 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__21173;
frames = G__21174;
continue;
...
var G__21175 = db;
var G__21176 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__21158 = cljs.core.first(remaining);
