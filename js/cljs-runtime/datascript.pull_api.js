...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__20721){
...
var frame = first__20724;
var frames = seq__20723__$1;
...
var results = (function (){var G__20725 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
...
var pattern_20773 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_20773,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
...
var as_value = (function (){var G__20735 = datom_val;
if(ref_QMARK_){
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__20736 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__20736);
} else {
return G__20736;
}
})()));
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20756__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20756__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__20758 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__20758,attr,eid);
} else {
return G__20758;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20759__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20759__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__20761){
while(true){
...
var frame = first__20764;
var frames = seq__20763__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__20777 = db;
var G__20778 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__20777;
p__20761 = G__20778;
continue;
}
...
case "expand":
var G__20780 = db;
var G__20781 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__20780;
frames = G__20781;
continue;
...
case "expand-rev":
var G__20782 = db;
var G__20783 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__20782;
frames = G__20783;
continue;
...
case "pattern":
var G__20784 = db;
var G__20785 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__20784;
frames = G__20785;
continue;
...
var G__20789 = db;
var G__20790 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__20771 = cljs.core.first(remaining);
