...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20717__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20717__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__20720 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__20720__$1 = (((G__20720 == null))?null:cljs.core.persistent_BANG_(G__20720));
if((G__20720__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__20720__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__20722){
...
var frame = first__20725;
var frames = seq__20724__$1;
...
var results = (function (){var G__20726 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__20726,kvps);
} else {
return G__20726;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20727__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20727__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_20776 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_20776,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__20731){
...
var parent = first__20734;
var frames = seq__20733__$1;
...
var found = cljs.core.not_empty((function (){var G__20735 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__20735);
} else {
return G__20735;
}
})());
...
var as_value = (function (){var G__20736 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__20729_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__20729_SHARP_]);
}),G__20736);
} else {
return G__20736;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__20737 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__20737);
} else {
return G__20737;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__20738 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__20738,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__20738;
}
})());
...
var vec__20739 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20739,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20739,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__20742){
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__20747){
...
var frame = first__20750;
var frames = seq__20749__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__20751){
...
var frame = first__20754;
var frames = seq__20753__$1;
...
var vec__20755 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20755,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20755,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20759__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20759__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__20761 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__20761,attr,eid);
} else {
return G__20761;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20762__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20762__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__20764){
while(true){
...
var frame = first__20767;
var frames = seq__20766__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__20778 = db;
var G__20779 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__20778;
p__20764 = G__20779;
continue;
}
...
while(true){
var G__20768 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__20768__$1 = (((G__20768 instanceof cljs.core.Keyword))?G__20768.fqn:null);
switch (G__20768__$1) {
case "expand":
var G__20781 = db;
var G__20782 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__20781;
frames = G__20782;
continue;
...
case "expand-rev":
var G__20783 = db;
var G__20784 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__20783;
frames = G__20784;
continue;
...
case "pattern":
var G__20785 = db;
var G__20786 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__20785;
frames = G__20786;
continue;
...
case "recursion":
var G__20787 = db;
var G__20788 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__20787;
frames = G__20788;
continue;
...
var f = first__20771;
var remaining = seq__20770__$1;
var result = (function (){var G__20772 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__20772);
} else {
return G__20772;
}
})();
...
var G__20789 = db;
var G__20790 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__20773 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__20773,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__20773;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20768__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__20775_SHARP_){
return datascript.db.entid_strict(db,p1__20775_SHARP_);
})),eids);
