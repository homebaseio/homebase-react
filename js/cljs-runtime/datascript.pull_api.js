...
var map__20721 = rec;
var map__20721__$1 = (((((!((map__20721 == null))))?(((((map__20721.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20721.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20721):map__20721);
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20721__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20721__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__20723 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__20723__$1 = (((G__20723 == null))?null:cljs.core.persistent_BANG_(G__20723));
if((G__20723__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__20723__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__20724){
...
var frame = first__20727;
var frames = seq__20726__$1;
...
var results = (function (){var G__20729 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__20729,kvps);
} else {
return G__20729;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20730__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20730__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_20778 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_20778,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__20733){
...
var parent = first__20736;
var frames = seq__20735__$1;
...
var found = cljs.core.not_empty((function (){var G__20737 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__20737);
} else {
return G__20737;
}
})());
...
var as_value = (function (){var G__20738 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__20732_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__20732_SHARP_]);
}),G__20738);
} else {
return G__20738;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__20739 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__20739);
} else {
return G__20739;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__20740 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__20740,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__20740;
}
})());
...
var vec__20741 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20741,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20741,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__20744){
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__20749){
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__20753){
...
var frame = first__20756;
var frames = seq__20755__$1;
...
var vec__20757 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20757,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20757,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20760__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20760__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__20762 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__20762,attr,eid);
} else {
return G__20762;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20763__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20763__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__20766){
while(true){
...
var frame = first__20769;
var frames = seq__20768__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__20779 = db;
var G__20780 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__20779;
p__20766 = G__20780;
continue;
}
...
while(true){
var G__20770 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__20770__$1 = (((G__20770 instanceof cljs.core.Keyword))?G__20770.fqn:null);
switch (G__20770__$1) {
case "expand":
var G__20782 = db;
var G__20783 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__20782;
frames = G__20783;
continue;
...
case "expand-rev":
var G__20784 = db;
var G__20785 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__20784;
frames = G__20785;
continue;
...
case "pattern":
var G__20786 = db;
var G__20787 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__20786;
frames = G__20787;
continue;
...
case "recursion":
var G__20788 = db;
var G__20789 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__20788;
frames = G__20789;
continue;
...
var f = first__20773;
var remaining = seq__20772__$1;
var result = (function (){var G__20774 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__20774);
} else {
return G__20774;
}
})();
...
var G__20790 = db;
var G__20791 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__20775 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__20775,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__20775;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20770__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__20776_SHARP_){
return datascript.db.entid_strict(db,p1__20776_SHARP_);
})),eids);
