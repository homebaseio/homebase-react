...
var map__21122 = parent;
var map__21122__$1 = (((((!((map__21122 == null))))?(((((map__21122.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21122.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__21122):map__21122);
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21122__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21122__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_21227 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_21227,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__21125){
...
var parent = first__21128;
var frames = seq__21127__$1;
...
var found = cljs.core.not_empty((function (){var G__21129 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__21129);
} else {
return G__21129;
}
})());
...
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__21124_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__21124_SHARP_]);
}),G__21133);
} else {
return G__21133;
}
...
var rec = (function (){var G__21173 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__21173,attr,eid);
} else {
return G__21173;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21177__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21177__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__21180){
while(true){
...
var frame = first__21183;
var frames = seq__21182__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__21256 = db;
var G__21257 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__21256;
p__21180 = G__21257;
continue;
}
...
while(true){
var G__21213 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__21213__$1 = (((G__21213 instanceof cljs.core.Keyword))?G__21213.fqn:null);
switch (G__21213__$1) {
case "expand":
var G__21259 = db;
var G__21260 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__21259;
frames = G__21260;
continue;
...
case "expand-rev":
var G__21261 = db;
var G__21262 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__21261;
frames = G__21262;
continue;
...
case "pattern":
var G__21263 = db;
var G__21264 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__21263;
frames = G__21264;
continue;
...
case "recursion":
var G__21265 = db;
var G__21266 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__21265;
frames = G__21266;
continue;
...
var f = first__21219;
var remaining = seq__21218__$1;
var result = (function (){var G__21221 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__21221);
} else {
return G__21221;
}
})();
...
var G__21267 = db;
var G__21268 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__21222 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__21222,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__21222;
}
})());
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__21223_SHARP_){
return datascript.db.entid_strict(db,p1__21223_SHARP_);
})),eids);
