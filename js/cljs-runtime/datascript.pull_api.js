...
var pattern_21178 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_21178,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
...
var G__21191 = db;
var G__21192 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__21191;
p__21159 = G__21192;
continue;
}
...
case "expand":
var G__21194 = db;
var G__21195 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__21194;
frames = G__21195;
continue;
...
case "expand-rev":
var G__21196 = db;
var G__21197 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__21196;
frames = G__21197;
continue;
...
case "pattern":
var G__21198 = db;
var G__21199 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__21198;
frames = G__21199;
continue;
...
case "recursion":
var G__21200 = db;
var G__21201 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__21200;
frames = G__21201;
continue;
...
var G__21202 = db;
var G__21203 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__21168 = cljs.core.first(remaining);
