...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20719__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20719__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__20721 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__20721__$1 = (((G__20721 == null))?null:cljs.core.persistent_BANG_(G__20721));
if((G__20721__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__20721__$1,key);
}
});
...
var results = (function (){var G__20727 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__20727,kvps);
} else {
return G__20727;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20728__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20728__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_20781 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_20781,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
...
var parent = first__20735;
var frames = seq__20734__$1;
...
var found = cljs.core.not_empty((function (){var G__20736 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__20736);
} else {
return G__20736;
}
})());
...
var as_value = (function (){var G__20737 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__20730_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__20730_SHARP_]);
}),G__20737);
} else {
return G__20737;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__20738 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__20738);
} else {
return G__20738;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__20739 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__20739,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__20739;
}
})());
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__20748){
var vec__20749 = p__20748;
var seq__20750 = cljs.core.seq(vec__20749);
var first__20751 = cljs.core.first(seq__20750);
var seq__20750__$1 = cljs.core.next(seq__20750);
var frame = first__20751;
var frames = seq__20750__$1;
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__20767){
while(true){
...
var frame = first__20770;
var frames = seq__20769__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__20784 = db;
var G__20785 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__20784;
p__20767 = G__20785;
continue;
}
...
while(true){
var G__20771 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__20771__$1 = (((G__20771 instanceof cljs.core.Keyword))?G__20771.fqn:null);
switch (G__20771__$1) {
case "expand":
var G__20787 = db;
var G__20788 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__20787;
frames = G__20788;
continue;
...
case "expand-rev":
var G__20789 = db;
var G__20790 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__20789;
frames = G__20790;
continue;
...
case "pattern":
var G__20791 = db;
var G__20792 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__20791;
frames = G__20792;
continue;
...
case "recursion":
var G__20793 = db;
var G__20794 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__20793;
frames = G__20794;
continue;
...
var f = first__20774;
var remaining = seq__20773__$1;
var result = (function (){var G__20775 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__20775);
} else {
return G__20775;
}
})();
...
var G__20795 = db;
var G__20796 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__20776 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__20776,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__20776;
}
})());
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__20777_SHARP_){
return datascript.db.entid_strict(db,p1__20777_SHARP_);
})),eids);
