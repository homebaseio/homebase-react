...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20724__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20724__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__20727){
...
var found = cljs.core.not_empty((function (){var G__20731 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__20731);
} else {
return G__20731;
}
})());
...
var as_value = (function (){var G__20733 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__20726_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__20726_SHARP_]);
}),G__20733);
} else {
return G__20733;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__20734 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__20734);
} else {
return G__20734;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__20735 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__20735,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__20735;
}
})());
...
var vec__20736 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20736,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20736,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__20740){
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__20744){
...
var frame = first__20747;
var frames = seq__20746__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__20748){
...
var vec__20752 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20752,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20752,(1),null);
...
var map__20755 = frame;
var map__20755__$1 = (((((!((map__20755 == null))))?(((((map__20755.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20755.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20755):map__20755);
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20755__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20755__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__20757 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__20757,attr,eid);
} else {
return G__20757;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20758__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20758__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var G__20775 = db;
var G__20776 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__20775;
p__20761 = G__20776;
continue;
}
...
while(true){
var G__20765 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__20765__$1 = (((G__20765 instanceof cljs.core.Keyword))?G__20765.fqn:null);
switch (G__20765__$1) {
case "expand":
var G__20778 = db;
var G__20779 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__20778;
frames = G__20779;
continue;
...
case "expand-rev":
var G__20780 = db;
var G__20781 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__20780;
frames = G__20781;
continue;
...
case "pattern":
var G__20782 = db;
var G__20783 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__20782;
frames = G__20783;
continue;
...
case "recursion":
var G__20784 = db;
var G__20785 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__20784;
frames = G__20785;
continue;
...
var f = first__20768;
var remaining = seq__20767__$1;
var result = (function (){var G__20769 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__20769);
} else {
return G__20769;
}
})();
...
var G__20786 = db;
var G__20787 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__20770 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__20770,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__20770;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20765__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__20771_SHARP_){
return datascript.db.entid_strict(db,p1__20771_SHARP_);
})),eids);
