...
var G__16533 = "span";
var G__16534 = ({"className": class$, "key": devcards.util.edn_renderer.get_key()});
var G__16535 = sablono.interpreter.interpret(devcards.util.utils.pprint_str(x));
...
devcards.util.edn_renderer.html_keyval = (function devcards$util$edn_renderer$html_keyval(p__16539){
