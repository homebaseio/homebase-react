...
var iter__4529__auto__ = (function sablono$core$update_arglists_$_iter__15418(s__15419){
return (new cljs.core.LazySeq(null,(function (){
var s__15419__$1 = s__15419;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__15419__$1);
if(temp__5735__auto__){
var s__15419__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__15419__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__15419__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__15421 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__15420 = (0);
while(true){
if((i__15420 < size__4528__auto__)){
var args = cljs.core._nth(c__4527__auto__,i__15420);
cljs.core.chunk_append(b__15421,cljs.core.vec(cljs.core.cons(new cljs.core.Symbol(null,"attr-map?","attr-map?",116307443,null),args)));

var G__15729 = (i__15420 + (1));
i__15420 = G__15729;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__15421),sablono$core$update_arglists_$_iter__15418(cljs.core.chunk_rest(s__15419__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__15421),null);
}
} else {
var args = cljs.core.first(s__15419__$2);
return cljs.core.cons(cljs.core.vec(cljs.core.cons(new cljs.core.Symbol(null,"attr-map?","attr-map?",116307443,null),args)),sablono$core$update_arglists_$_iter__15418(cljs.core.rest(s__15419__$2)));
}
} else {
return null;
}
...
var G__15742 = (i__4737__auto___15735 + (1));
i__4737__auto___15735 = G__15742;
continue;
} else {
}
break;
...
var iter__4529__auto__ = (function sablono$core$iter__15439(s__15440){
return (new cljs.core.LazySeq(null,(function (){
var s__15440__$1 = s__15440;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__15440__$1);
if(temp__5735__auto__){
var s__15440__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__15440__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__15440__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__15442 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__15441 = (0);
while(true){
if((i__15441 < size__4528__auto__)){
var style = cljs.core._nth(c__4527__auto__,i__15441);
cljs.core.chunk_append(b__15442,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"link","link",-1769163468),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"text/css",new cljs.core.Keyword(null,"href","href",-793805698),sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([style], 0)),new cljs.core.Keyword(null,"rel","rel",1378823488),"stylesheet"], null)], null));

var G__15743 = (i__15441 + (1));
i__15441 = G__15743;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__15442),sablono$core$iter__15439(cljs.core.chunk_rest(s__15440__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__15442),null);
}
} else {
var style = cljs.core.first(s__15440__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"link","link",-1769163468),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"text/css",new cljs.core.Keyword(null,"href","href",-793805698),sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([style], 0)),new cljs.core.Keyword(null,"rel","rel",1378823488),"stylesheet"], null)], null),sablono$core$iter__15439(cljs.core.rest(s__15440__$2)));
}
} else {
return null;
}
 ...
 */
sablono.core.link_to15443 = (function sablono$core$link_to15443(var_args){
var args__4742__auto__ = [];
...
return sablono.core.link_to15443.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4743__auto__);
});

(sablono.core.link_to15443.cljs$core$IFn$_invoke$arity$variadic = (function (url,content){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([url], 0))], null),content], null);
}));

(sablono.core.link_to15443.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(sablono.core.link_to15443.cljs$lang$applyTo = (function (seq15468){
...
sablono.core.link_to = sablono.core.wrap_attrs(sablono.core.link_to15443);
/**
 ...
 */
sablono.core.date_field15537 = (function sablono$core$date_field15537(var_args){
var G__15540 = arguments.length;
switch (G__15540) {
case 1:
return sablono.core.date_field15537.cljs$core$IFn$_invoke$arity$1((arguments[(0)]));

break;
case 2:
return sablono.core.date_field15537.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));
...
(sablono.core.date_field15537.cljs$core$IFn$_invoke$arity$1 = (function (name__15390__auto__){
...
(sablono.core.date_field15537.cljs$core$IFn$_invoke$arity$2 = (function (name__15390__auto__,value__15391__auto__){
...
(sablono.core.date_field15537.cljs$lang$maxFixedArity = 2);


sablono.core.date_field = sablono.core.wrap_attrs(sablono.core.date_field15537);
 ...
 */
sablono.core.datetime_local_field15563 = (function sablono$core$datetime_local_field15563(var_args){
var G__15565 = arguments.length;
switch (G__15565) {
case 1:
return sablono.core.datetime_local_field15563.cljs$core$IFn$_invoke$arity$1((arguments[(0)]));

break;
case 2:
return sablono.core.datetime_local_field15563.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));
...
(sablono.core.datetime_local_field15563.cljs$core$IFn$_invoke$arity$1 = (function (name__15390__auto__){
...
(sablono.core.datetime_local_field15563.cljs$core$IFn$_invoke$arity$2 = (function (name__15390__auto__,value__15391__auto__){
...
(sablono.core.datetime_local_field15563.cljs$lang$maxFixedArity = 2);


sablono.core.datetime_local_field = sablono.core.wrap_attrs(sablono.core.datetime_local_field15563);

/**
 * Creates a email input field.
 */
sablono.core.email_field15566 = (function sablono$core$email_field15566(var_args){
var G__15568 = arguments.length;
switch (G__15568) {
case 1:
return sablono.core.email_field15566.cljs$core$IFn$_invoke$arity$1((arguments[(0)]));

break;
case 2:
return sablono.core.email_field15566.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));
...
(sablono.core.email_field15566.cljs$core$IFn$_invoke$arity$1 = (function (name__15390__auto__){
...
(sablono.core.email_field15566.cljs$core$IFn$_invoke$arity$2 = (function (name__15390__auto__,value__15391__auto__){
...
(sablono.core.email_field15566.cljs$lang$maxFixedArity = 2);


sablono.core.email_field = sablono.core.wrap_attrs(sablono.core.email_field15566);

/**
 * Creates a file input field.
 */
sablono.core.file_field15569 = (function sablono$core$file_field15569(var_args){
var G__15571 = arguments.length;
switch (G__15571) {
case 1:
return sablono.core.file_field15569.cljs$core$IFn$_invoke$arity$1((arguments[(0)]));

break;
case 2:
return sablono.core.file_field15569.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));
...
(sablono.core.file_field15569.cljs$core$IFn$_invoke$arity$1 = (function (name__15390__auto__){
...
(sablono.core.file_field15569.cljs$core$IFn$_invoke$arity$2 = (function (name__15390__auto__,value__15391__auto__){
...
(sablono.core.file_field15569.cljs$lang$maxFixedArity = 2);


sablono.core.file_field = sablono.core.wrap_attrs(sablono.core.file_field15569);

/**
 * Creates a hidden input field.
 */
sablono.core.hidden_field15572 = (function sablono$core$hidden_field15572(var_args){
var G__15574 = arguments.length;
switch (G__15574) {
case 1:
return sablono.core.hidden_field15572.cljs$core$IFn$_invoke$arity$1((arguments[(0)]));

break;
case 2:
return sablono.core.hidden_field15572.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));
...
(sablono.core.hidden_field15572.cljs$core$IFn$_invoke$arity$1 = (function (name__15390__auto__){
...
(sablono.core.hidden_field15572.cljs$core$IFn$_invoke$arity$2 = (function (name__15390__auto__,value__15391__auto__){
...
(sablono.core.hidden_field15572.cljs$lang$maxFixedArity = 2);


sablono.core.hidden_field = sablono.core.wrap_attrs(sablono.core.hidden_field15572);
 ...
 */
sablono.core.time_field15604 = (function sablono$core$time_field15604(var_args){
var G__15609 = arguments.length;
switch (G__15609) {
case 1:
return sablono.core.time_field15604.cljs$core$IFn$_invoke$arity$1((arguments[(0)]));

break;
case 2:
return sablono.core.time_field15604.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));
...
(sablono.core.time_field15604.cljs$core$IFn$_invoke$arity$1 = (function (name__15390__auto__){
...
(sablono.core.time_field15604.cljs$core$IFn$_invoke$arity$2 = (function (name__15390__auto__,value__15391__auto__){
...
(sablono.core.time_field15604.cljs$lang$maxFixedArity = 2);


sablono.core.time_field = sablono.core.wrap_attrs(sablono.core.time_field15604);
 ...
 */
sablono.core.week_field15619 = (function sablono$core$week_field15619(var_args){
var G__15621 = arguments.length;
switch (G__15621) {
case 1:
return sablono.core.week_field15619.cljs$core$IFn$_invoke$arity$1((arguments[(0)]));

break;
case 2:
return sablono.core.week_field15619.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));
...
(sablono.core.week_field15619.cljs$core$IFn$_invoke$arity$1 = (function (name__15390__auto__){
...
(sablono.core.week_field15619.cljs$core$IFn$_invoke$arity$2 = (function (name__15390__auto__,value__15391__auto__){
...
(sablono.core.week_field15619.cljs$lang$maxFixedArity = 2);


sablono.core.week_field = sablono.core.wrap_attrs(sablono.core.week_field15619);
sablono.core.file_upload = sablono.core.file_field;
/**
 * Creates a check box.
 */
sablono.core.check_box15622 = (function sablono$core$check_box15622(var_args){
var G__15624 = arguments.length;
switch (G__15624) {
case 1:
return sablono.core.check_box15622.cljs$core$IFn$_invoke$arity$1((arguments[(0)]));

break;
case 2:
return sablono.core.check_box15622.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));

break;
case 3:
return sablono.core.check_box15622.cljs$core$IFn$_invoke$arity$3((arguments[(0)]),(arguments[(1)]),(arguments[(2)]));
...
(sablono.core.check_box15622.cljs$core$IFn$_invoke$arity$1 = (function (name){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"name","name",1843675177),sablono.core.make_name(name),new cljs.core.Keyword(null,"id","id",-1388402092),sablono.core.make_id(name)], null)], null);
}));

(sablono.core.check_box15622.cljs$core$IFn$_invoke$arity$2 = (function (name,checked_QMARK_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"name","name",1843675177),sablono.core.make_name(name),new cljs.core.Keyword(null,"id","id",-1388402092),sablono.core.make_id(name),new cljs.core.Keyword(null,"checked","checked",-50955819),checked_QMARK_], null)], null);
}));

(sablono.core.check_box15622.cljs$core$IFn$_invoke$arity$3 = (function (name,checked_QMARK_,value){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"name","name",1843675177),sablono.core.make_name(name),new cljs.core.Keyword(null,"id","id",-1388402092),sablono.core.make_id(name),new cljs.core.Keyword(null,"value","value",305978217),value,new cljs.core.Keyword(null,"checked","checked",-50955819),checked_QMARK_], null)], null);
}));

(sablono.core.check_box15622.cljs$lang$maxFixedArity = 3);


sablono.core.check_box = sablono.core.wrap_attrs(sablono.core.check_box15622);
/**
 ...
 */
sablono.core.label15699 = (function sablono$core$label15699(name,text){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"htmlFor","htmlFor",-1050291720),sablono.core.make_id(name)], null),text], null);
});

sablono.core.label = sablono.core.wrap_attrs(sablono.core.label15699);
/**
 * Creates a submit button.
 */
sablono.core.submit_button15700 = (function sablono$core$submit_button15700(text){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),"submit",new cljs.core.Keyword(null,"value","value",305978217),text], null)], null);
});

sablono.core.submit_button = sablono.core.wrap_attrs(sablono.core.submit_button15700);
/**
